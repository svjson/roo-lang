    ...
    std::string generated_main_cpp()
    {
      ...
      out
        << "#include <cstddef>\n"
           ...
           "  }\n\n"
           "  Lisple::sptr_val cli_args_value(int argc, char** argv)\n"
           "  {\n"
           ...
           "    {\n"
           "      values.push_back(Lisple::Value::string(argv[i]));\n"
           "    }\n"
           "    return Lisple::Value::vector(values);\n"
           "  }\n\n"
           "  std::size_t main_arity(const Lisple::Executable& executable,\n"
           "                         const std::string& main_function)\n"
           "  {\n"
           "    const Lisple::Signature* fallback = nullptr;\n"
           ...
           "    }\n"
           "    throw Lisple::LispleException(\"Compiled package :main is not callable as "
           "a "
           "runtime function: \" + main_function);\n"
           "  }\n\n"
           "  Lisple::sptr_val_v main_args_for_arity(std::size_t arity,\n"
           "                                         const Lisple::sptr_val& cli_args)\n"
           "  {\n"
           ...
           "    {\n"
           "      args.push_back(Lisple::Constant::NIL);\n"
           "    }\n"
           "    return args;\n"
           "  }\n\n"
           "  void invoke_main(Lisple::Runtime& runtime,\n"
           "                   const std::string& main_function,\n"
           "                   int argc,\n"
           "                   char** argv)\n"
           "  {\n"
           ...
           "    {\n"
           "      throw Lisple::LispleException(\"Compiled package :main must be a "
           "qualified "
           "function.\");\n"
           "    }\n"
           "    load_namespaces(runtime,\n"
           "                    {main_namespace},\n"
           "                    \"lisple.compiled.main\",\n"
           "                    \"<package-main>\");\n"
           "    const auto main_value = runtime.lookup(main_function);\n"
           "    if (main_value->type != Lisple::Value::Type::FUNCTION)\n"
           "    {\n"
           "      throw Lisple::LispleException(\"Compiled package :main is not a "
           "function: \" + main_function);\n"
           "    }\n"
           "    Lisple::sptr_val_v args = main_args_for_arity(\n"
           "      main_arity(main_value->exec(), main_function), cli_args_value(argc, "
           "argv));\n"
           "    runtime.invoke(main_function, args);\n"
           "  }\n"
           "} // namespace\n\n"
           ...
           "\"<package-entry>\");\n"
           "    invoke_main(runtime, main_function, argc, argv);\n"
           "  }\n"
