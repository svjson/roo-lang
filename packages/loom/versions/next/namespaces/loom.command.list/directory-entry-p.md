---
layout: reference
title: loom.command.list/directory-entry?
---
...
<option value="../../../{{ publication.identity }}/namespaces/loom.command.list/directory-entry-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
