---
layout: reference
title: loom.common.dependency-graph/source-dependency-root
---
...
<li><a class="active" href="source-dependency-root.html">source-dependency-root</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">source-dependency-root</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/loom.common.dependency-graph/source-dependency-root.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../loom.common.dependency-graph.html">loom.common.dependency-graph</a>/</div>
<h1><code>source-dependency-root</code></h1>
</header>

Resolve a dependency to its source-package directory.

<hr class="signature-divider">

```roo
(source-dependency-root package-root source-root {:keys [name path]})
```
...
| source-root         | Directory containing named source packages.<br>- `name`: Declared dependency name.<br>- `path`: Optional path declared by the dependency. |
| {:keys [name path]} |                                                                                                                                           |

### Returns:

The dependency source directory.
