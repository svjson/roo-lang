---
layout: reference
title: loom.common.dependency-graph/dependency-spec-from-map
---
...
<li><a class="active" href="dependency-spec-from-map.html">dependency-spec-from-map</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">dependency-spec-from-map</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/loom.common.dependency-graph/dependency-spec-from-map.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../loom.common.dependency-graph.html">loom.common.dependency-graph</a>/</div>
<h1><code>dependency-spec-from-map</code></h1>
</header>

<hr class="signature-divider">

```roo
(dependency-spec-from-map name value)
```
