---
layout: reference
title: loom.common.dependency-graph/dependency-path-root
---
...
<li><a class="active" href="dependency-path-root.html">dependency-path-root</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">dependency-path-root</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/loom.common.dependency-graph/dependency-path-root.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../loom.common.dependency-graph.html">loom.common.dependency-graph</a>/</div>
<h1><code>dependency-path-root</code></h1>
</header>

<hr class="signature-divider">

```roo
(dependency-path-root package-root {:keys [path] :as spec})
```
