---
layout: reference
title: loom.common.dependency-graph/file-path
---
...
<li><a class="active" href="file-path.html">file-path</a></li>
...
<option value="../../../{{ publication.identity }}/namespaces/loom.common.dependency-graph/file-path.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../loom.common.dependency-graph.html">loom.common.dependency-graph</a>/</div>
<h1><code>file-path</code></h1>
</header>
