---
layout: reference
title: loom.common.dependency-graph/source-root-node!
---
...
<li><a class="active" href="source-root-node-bang.html">source-root-node!</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">source-root-node!</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/loom.common.dependency-graph/source-root-node-bang.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../loom.common.dependency-graph.html">loom.common.dependency-graph</a>/</div>
<h1><code>source-root-node!</code></h1>
</header>

Build a dependency graph from source packages.

<hr class="signature-divider">

```roo
(source-root-node! package-dir source-root)
```
...
| Arg         | Description                                 |
| ----------- | ------------------------------------------- |
| package-dir | Root package directory.                     |
| source-root | Directory containing named source packages. |

### Returns:

The root dependency-graph node, or nil when the manifest is invalid.
