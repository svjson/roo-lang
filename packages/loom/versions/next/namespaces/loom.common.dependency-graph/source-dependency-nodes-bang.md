---
layout: reference
title: loom.common.dependency-graph/source-dependency-nodes!
---
...
<li><a href="collect-cycle-package-ids.html">collect-cycle-package-ids</a></li>
...
<li><a class="active" href="source-dependency-nodes-bang.html">source-dependency-nodes!</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">source-dependency-nodes!</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/loom.common.dependency-graph/source-dependency-nodes-bang.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../loom.common.dependency-graph.html">loom.common.dependency-graph</a>/</div>
<h1><code>source-dependency-nodes!</code></h1>
</header>

Build source dependency nodes for SPECS.

<hr class="signature-divider">

```roo
(source-dependency-nodes! package-root source-root specs ancestors)
```
...
| Arg          | Description                                           |
| ------------ | ----------------------------------------------------- |
| package-root | Directory containing the dependent package.           |
| source-root  | Directory containing named source packages.           |
| specs        | Dependency specifications to resolve.                 |
| ancestors    | Package IDs already present in the active graph path. |

### Returns:

Dependency-graph nodes corresponding to SPECS.
