---
layout: reference
title: loom.common.dependency-graph/normalize-name
---
...
<option value="../../../{{ publication.identity }}/namespaces/loom.common.dependency-graph/normalize-name.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
