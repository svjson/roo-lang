---
layout: reference
title: loom.common.dependency-graph/collect-missing-package-ids
---
...
<li><a class="active" href="collect-missing-package-ids.html">collect-missing-package-ids</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">collect-missing-package-ids</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/loom.common.dependency-graph/collect-missing-package-ids.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../loom.common.dependency-graph.html">loom.common.dependency-graph</a>/</div>
<h1><code>collect-missing-package-ids</code></h1>
</header>

<hr class="signature-divider">

```roo
(collect-missing-package-ids node)
```
