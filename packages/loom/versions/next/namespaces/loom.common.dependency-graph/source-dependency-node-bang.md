---
layout: reference
title: loom.common.dependency-graph/source-dependency-node!
---
...
<li><a class="active" href="source-dependency-node-bang.html">source-dependency-node!</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">source-dependency-node!</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/loom.common.dependency-graph/source-dependency-node-bang.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../loom.common.dependency-graph.html">loom.common.dependency-graph</a>/</div>
<h1><code>source-dependency-node!</code></h1>
</header>

Build a source dependency node and its transitive dependencies.

<hr class="signature-divider">

```roo
(source-dependency-node! package-root source-root spec ancestors)
```
...
A dependency-graph node marked when missing or cyclic.
