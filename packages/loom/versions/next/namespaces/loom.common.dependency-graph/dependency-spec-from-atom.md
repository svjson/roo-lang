---
layout: reference
title: loom.common.dependency-graph/dependency-spec-from-atom
---
...
<li><a class="active" href="dependency-spec-from-atom.html">dependency-spec-from-atom</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">dependency-spec-from-atom</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/loom.common.dependency-graph/dependency-spec-from-atom.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../loom.common.dependency-graph.html">loom.common.dependency-graph</a>/</div>
<h1><code>dependency-spec-from-atom</code></h1>
</header>

<hr class="signature-divider">

```roo
(dependency-spec-from-atom name value)
```
