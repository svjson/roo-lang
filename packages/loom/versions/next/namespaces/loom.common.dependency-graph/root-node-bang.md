---
layout: reference
title: loom.common.dependency-graph/root-node!
---
...
<li><a class="active" href="root-node-bang.html">root-node!</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">root-node!</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/loom.common.dependency-graph/root-node-bang.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../loom.common.dependency-graph.html">loom.common.dependency-graph</a>/</div>
<h1><code>root-node!</code></h1>
</header>

<hr class="signature-divider">

```roo
(root-node! package-dir repo-root)
```
