---
layout: reference
title: loom.common.dependency-graph/package-node
---
...
<li><a class="active" href="package-node.html">package-node</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">package-node</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/loom.common.dependency-graph/package-node.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../loom.common.dependency-graph.html">loom.common.dependency-graph</a>/</div>
<h1><code>package-node</code></h1>
</header>

<hr class="signature-divider">

```roo
(package-node name version path missing? cycle? dependencies)
```
