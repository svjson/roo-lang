---
layout: reference
title: loom.common.dependency-graph/dependency-nodes!
---
...
<li><a class="active" href="dependency-nodes-bang.html">dependency-nodes!</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">dependency-nodes!</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/loom.common.dependency-graph/dependency-nodes-bang.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../loom.common.dependency-graph.html">loom.common.dependency-graph</a>/</div>
<h1><code>dependency-nodes!</code></h1>
</header>

<hr class="signature-divider">

```roo
(dependency-nodes! package-root repo-root specs ancestors)
```
