---
layout: reference
title: loom.common.dependency-graph/spec-root
---
...
<li><a class="active" href="spec-root.html">spec-root</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">spec-root</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/loom.common.dependency-graph/spec-root.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../loom.common.dependency-graph.html">loom.common.dependency-graph</a>/</div>
<h1><code>spec-root</code></h1>
</header>

<hr class="signature-divider">

```roo
(spec-root package-root repo-root {:keys [path] :as spec})
```
