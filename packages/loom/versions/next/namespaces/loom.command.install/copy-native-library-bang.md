---
layout: reference
title: loom.command.install/copy-native-library!
---
...
<li><a class="active" href="copy-native-library-bang.html">copy-native-library!</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">copy-native-library!</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/loom.command.install/copy-native-library-bang.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../loom.command.install.html">loom.command.install</a>/</div>
<h1><code>copy-native-library!</code></h1>
</header>
