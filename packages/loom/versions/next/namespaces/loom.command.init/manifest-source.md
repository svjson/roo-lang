---
layout: reference
title: loom.command.init/manifest-source
---
...
<ol>
<li><a href="init-bang.html">init!</a></li>
<li><a class="active" href="manifest-source.html">manifest-source</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">manifest-source</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/loom.command.init/manifest-source.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../loom.command.init.html">loom.command.init</a>/</div>
<h1><code>manifest-source</code></h1>
</header>

<hr class="signature-divider">

```roo
(manifest-source name version)
```
