...
<li><a class="active" href="dispatch-bang.html">dispatch!</a></li>
...
<option value="../../../{{ publication.identity }}/namespaces/voodoo.session/dispatch-bang.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
