---
layout: reference
title: voodoo.session/reset-terminal-cursor!
---
...
<li><a class="active" href="reset-terminal-cursor-bang.html">reset-terminal-cursor!</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">reset-terminal-cursor!</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/voodoo.session/reset-terminal-cursor-bang.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../voodoo.session.html">voodoo.session</a>/</div>
<h1><code>reset-terminal-cursor!</code></h1>
</header>
