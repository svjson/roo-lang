---
layout: reference
title: voodoo.session/total-height
---
...
<li><a class="active" href="total-height.html">total-height</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">total-height</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/voodoo.session/total-height.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../voodoo.session.html">voodoo.session</a>/</div>
<h1><code>total-height</code></h1>
</header>

<hr class="signature-divider">

```roo
(total-height session ids)
```
