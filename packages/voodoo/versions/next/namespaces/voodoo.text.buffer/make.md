...
<option value="../../../{{ publication.identity }}/namespaces/voodoo.text.buffer/make.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
