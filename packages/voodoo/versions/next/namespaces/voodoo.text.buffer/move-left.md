---
layout: reference
title: voodoo.text.buffer/move-left
---
...
<li><a class="active" href="move-left.html">move-left</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">move-left</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/voodoo.text.buffer/move-left.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../voodoo.text.buffer.html">voodoo.text.buffer</a>/</div>
<h1><code>move-left</code></h1>
</header>
...
```roo
(move-left {:keys [before after] :as buffer})
```
