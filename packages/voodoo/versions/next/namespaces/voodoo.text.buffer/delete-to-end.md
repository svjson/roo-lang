---
layout: reference
title: voodoo.text.buffer/delete-to-end
---
...
<li><a class="active" href="delete-to-end.html">delete-to-end</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">delete-to-end</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/voodoo.text.buffer/delete-to-end.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../voodoo.text.buffer.html">voodoo.text.buffer</a>/</div>
<h1><code>delete-to-end</code></h1>
</header>
