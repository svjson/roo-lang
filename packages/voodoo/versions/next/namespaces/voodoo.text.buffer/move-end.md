---
layout: reference
title: voodoo.text.buffer/move-end
---
...
<li><a class="active" href="move-end.html">move-end</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">move-end</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/voodoo.text.buffer/move-end.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../voodoo.text.buffer.html">voodoo.text.buffer</a>/</div>
<h1><code>move-end</code></h1>
</header>
