---
layout: reference
title: voodoo.text.buffer/backspace
---
...
<ol>
<li><a class="active" href="backspace.html">backspace</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">backspace</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/voodoo.text.buffer/backspace.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../voodoo.text.buffer.html">voodoo.text.buffer</a>/</div>
<h1><code>backspace</code></h1>
</header>
...
```roo
(backspace {:keys [before after] :as buffer})
```
