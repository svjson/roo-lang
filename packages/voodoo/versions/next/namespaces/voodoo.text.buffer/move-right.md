---
layout: reference
title: voodoo.text.buffer/move-right
---
...
<li><a class="active" href="move-right.html">move-right</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">move-right</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/voodoo.text.buffer/move-right.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../voodoo.text.buffer.html">voodoo.text.buffer</a>/</div>
<h1><code>move-right</code></h1>
</header>
...
```roo
(move-right {:keys [before after] :as buffer})
```
