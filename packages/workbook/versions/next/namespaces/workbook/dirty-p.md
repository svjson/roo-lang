...
<option value="../../../{{ publication.identity }}/namespaces/workbook/dirty-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
