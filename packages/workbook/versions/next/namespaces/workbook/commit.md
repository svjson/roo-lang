...
<option value="../../../{{ publication.identity }}/namespaces/workbook/commit.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
