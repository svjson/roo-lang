...
<option value="../../../{{ publication.identity }}/namespaces/workbook/cancel.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
