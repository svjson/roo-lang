...
<option value="../../../{{ publication.identity }}/namespaces/workbook/undo-label.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
