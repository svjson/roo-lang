---
layout: reference
title: workbook/redo-label
---

<div class="reference-page">
<nav class="reference-sidebar">
<a class="namespace-link" href="../workbook.html">workbook</a>
<ol>
...
<option value="../../../{{ publication.identity }}/namespaces/workbook/redo-label.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../workbook.html">workbook</a>/</div>
