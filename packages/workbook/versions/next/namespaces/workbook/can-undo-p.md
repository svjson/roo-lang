...
<option value="../../../{{ publication.identity }}/namespaces/workbook/can-undo-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
