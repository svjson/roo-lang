...
<option value="../../../{{ publication.identity }}/namespaces/workbook/remove.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
