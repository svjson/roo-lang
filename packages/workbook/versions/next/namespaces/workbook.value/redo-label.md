---
layout: reference
title: workbook.value/redo-label
---
...
<option value="../../../{{ publication.identity }}/namespaces/workbook.value/redo-label.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
