...
<option value="../../../{{ publication.identity }}/namespaces/workbook.value/init.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
