---
layout: reference
title: workbook.value/initial-history
---
...
<option value="../../../{{ publication.identity }}/namespaces/workbook.value/initial-history.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
