...
<option value="../../../{{ publication.identity }}/namespaces/workbook.value/can-redo-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
