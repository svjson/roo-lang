...
<option value="../../../{{ publication.identity }}/namespaces/workbook.value/history.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
