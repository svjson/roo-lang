...
<option value="../../../{{ publication.identity }}/namespaces/workbook.value/value.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
