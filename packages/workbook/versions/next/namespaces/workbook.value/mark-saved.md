---
layout: reference
title: workbook.value/mark-saved
---
...
<option value="../../../{{ publication.identity }}/namespaces/workbook.value/mark-saved.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
