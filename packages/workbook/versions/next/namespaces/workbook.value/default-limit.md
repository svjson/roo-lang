---
layout: reference
title: workbook.value/default-limit
---
...
<li><a class="active" href="default-limit.html">default-limit</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">default-limit</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/workbook.value/default-limit.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../workbook.value.html">workbook.value</a>/</div>
<h1><code>default-limit</code></h1>
</header>
