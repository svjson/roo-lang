...
<option value="../../../{{ publication.identity }}/namespaces/workbook.core/can-undo-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
