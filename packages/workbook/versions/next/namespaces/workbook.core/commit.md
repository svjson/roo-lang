...
<option value="../../../{{ publication.identity }}/namespaces/workbook.core/commit.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
