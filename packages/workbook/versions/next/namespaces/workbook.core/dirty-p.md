...
<li><a class="active" href="dirty-p.html">dirty?</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">dirty?</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/workbook.core/dirty-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../workbook.core.html">workbook.core</a>/</div>
<h1><code>dirty?</code></h1>
</header>
