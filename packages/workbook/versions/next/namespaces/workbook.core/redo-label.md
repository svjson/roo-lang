---
layout: reference
title: workbook.core/redo-label
---
...
<li><a class="active" href="redo-label.html">redo-label</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">redo-label</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/workbook.core/redo-label.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../workbook.core.html">workbook.core</a>/</div>
<h1><code>redo-label</code></h1>
</header>
