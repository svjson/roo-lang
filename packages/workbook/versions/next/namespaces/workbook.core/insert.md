...
<option value="../../../{{ publication.identity }}/namespaces/workbook.core/insert.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
