...
<li><a class="active" href="init.html">init</a></li>
...
<option value="../../../{{ publication.identity }}/namespaces/workbook.core/init.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
