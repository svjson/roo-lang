...
<option value="../../../{{ publication.identity }}/namespaces/workbook.core/undo.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
