---
layout: reference
title: workbook.core/undo-label
---
...
<li><a class="active" href="undo-label.html">undo-label</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">undo-label</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/workbook.core/undo-label.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../workbook.core.html">workbook.core</a>/</div>
<h1><code>undo-label</code></h1>
</header>
