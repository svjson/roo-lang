---
layout: reference
title: workbook.core/initial-history
---

<div class="reference-page">
<nav class="reference-sidebar">
<a class="namespace-link" href="../workbook.core.html">workbook.core</a>
<ol>
<li><a href="begin.html">begin</a></li>
<li><a href="can-redo-p.html">can-redo?</a></li>
<li><a href="can-undo-p.html">can-undo?</a></li>
...
<li><a class="active" href="initial-history.html">initial-history</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<a href="../workbook.core.html">workbook.core</a>
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">initial-history</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/workbook.core/initial-history.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../workbook.core.html">workbook.core</a>/</div>
<h1><code>initial-history</code></h1>
</header>
