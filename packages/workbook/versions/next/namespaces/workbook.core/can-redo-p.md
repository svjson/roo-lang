...
<li><a class="active" href="can-redo-p.html">can-redo?</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">can-redo?</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/workbook.core/can-redo-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../workbook.core.html">workbook.core</a>/</div>
<h1><code>can-redo?</code></h1>
</header>
