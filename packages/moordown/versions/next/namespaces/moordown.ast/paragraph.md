...
<li><a class="active" href="paragraph.html">paragraph</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">paragraph</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/moordown.ast/paragraph.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../moordown.ast.html">moordown.ast</a>/</div>
<h1><code>paragraph</code></h1>
</header>
...
| Arg     | Description                    |
| ------- | ------------------------------ |
| content | Paragraph text or inline node. |
