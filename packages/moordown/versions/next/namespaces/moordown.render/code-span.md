---
layout: reference
title: moordown.render/code-span
---
...
<li><a class="active" href="code-span.html">code-span</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">code-span</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/moordown.render/code-span.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../moordown.render.html">moordown.render</a>/</div>
<h1><code>code-span</code></h1>
</header>

Render TEXT as Markdown inline code.
...
Markdown code span using a fence longer than any backtick run in TEXT.
