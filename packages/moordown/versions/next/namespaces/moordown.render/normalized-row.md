---
layout: reference
title: moordown.render/normalized-row
---
...
<li><a class="active" href="normalized-row.html">normalized-row</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">normalized-row</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/moordown.render/normalized-row.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../moordown.render.html">moordown.render</a>/</div>
<h1><code>normalized-row</code></h1>
</header>
