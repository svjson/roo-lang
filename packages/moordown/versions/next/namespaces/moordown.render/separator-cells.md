---
layout: reference
title: moordown.render/separator-cells
---
...
<li><a class="active" href="separator-cells.html">separator-cells</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">separator-cells</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/moordown.render/separator-cells.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../moordown.render.html">moordown.render</a>/</div>
<h1><code>separator-cells</code></h1>
</header>
