---
layout: reference
title: moordown.render/padded-cells
---
...
<li><a class="active" href="padded-cells.html">padded-cells</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">padded-cells</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/moordown.render/padded-cells.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../moordown.render.html">moordown.render</a>/</div>
<h1><code>padded-cells</code></h1>
</header>
