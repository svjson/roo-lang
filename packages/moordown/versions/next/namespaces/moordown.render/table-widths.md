---
layout: reference
title: moordown.render/table-widths
---
...
<li><a class="active" href="table-widths.html">table-widths</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">table-widths</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/moordown.render/table-widths.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../moordown.render.html">moordown.render</a>/</div>
<h1><code>table-widths</code></h1>
</header>
