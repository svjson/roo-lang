---
layout: reference
title: moordown.render/widen-column
---
...
<li><a class="active" href="widen-column.html">widen-column</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">widen-column</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/moordown.render/widen-column.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../moordown.render.html">moordown.render</a>/</div>
<h1><code>widen-column</code></h1>
</header>
...
```roo
(widen-column widths index cell)
```
