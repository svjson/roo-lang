---
layout: reference
title: moordown.render/render-inline
---
...
<li><a class="active" href="render-inline.html">render-inline</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">render-inline</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/moordown.render/render-inline.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../moordown.render.html">moordown.render</a>/</div>
<h1><code>render-inline</code></h1>
</header>
