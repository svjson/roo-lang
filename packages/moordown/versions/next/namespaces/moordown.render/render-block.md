---
layout: reference
title: moordown.render/render-block
---
...
<li><a class="active" href="render-block.html">render-block</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">render-block</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/moordown.render/render-block.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../moordown.render.html">moordown.render</a>/</div>
<h1><code>render-block</code></h1>
</header>
