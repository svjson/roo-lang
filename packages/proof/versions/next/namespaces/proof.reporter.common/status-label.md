---
layout: reference
title: proof.reporter.common/status-label
---
...
<li><a class="active" href="status-label.html">status-label</a></li>
</ol>
</nav>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">status-label</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proof.reporter.common/status-label.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proof.reporter.common.html">proof.reporter.common</a>/</div>
<h1><code>status-label</code></h1>
</header>
