---
layout: reference
title: proof.reporter.common/duration-args
---
...
<li><a class="active" href="duration-args.html">duration-args</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">duration-args</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proof.reporter.common/duration-args.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proof.reporter.common.html">proof.reporter.common</a>/</div>
<h1><code>duration-args</code></h1>
</header>

<hr class="signature-divider">

```roo
(duration-args options result)
```
