---
layout: reference
title: proof.reporter.common/padded-status-label
---
...
<li><a class="active" href="padded-status-label.html">padded-status-label</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">padded-status-label</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proof.reporter.common/padded-status-label.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proof.reporter.common.html">proof.reporter.common</a>/</div>
<h1><code>padded-status-label</code></h1>
</header>

<hr class="signature-divider">

```roo
(padded-status-label status)
```
