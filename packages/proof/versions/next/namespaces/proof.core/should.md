...
<li><a class="active" href="should.html">should</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">should</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proof.core/should.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proof.core.html">proof.core</a>/</div>
<h1><code>should</code></h1>
</header>
