...
<option value="../../../{{ publication.identity }}/namespaces/proof.core/run.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
