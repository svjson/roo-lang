...
<li><a class="active" href="is.html">is</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">is</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proof.core/is.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
...
<h1><code>is</code></h1>
<div class="symbol-metadata"><span>See also: <code>deftest</code></span></div>
</header>
