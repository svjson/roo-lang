---
layout: reference
title: proof.core/declared-namespace
---
...
<li><a class="active" href="declared-namespace.html">declared-namespace</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">declared-namespace</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proof.core/declared-namespace.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proof.core.html">proof.core</a>/</div>
<h1><code>declared-namespace</code></h1>
</header>
