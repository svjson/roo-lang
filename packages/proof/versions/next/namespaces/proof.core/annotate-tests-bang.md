---
layout: reference
title: proof.core/annotate-tests!
---
...
<ol>
<li><a class="active" href="annotate-tests-bang.html">annotate-tests!</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">annotate-tests!</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proof.core/annotate-tests-bang.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proof.core.html">proof.core</a>/</div>
<h1><code>annotate-tests!</code></h1>
</header>

<hr class="signature-divider">

```roo
(annotate-tests! metadata-by-namespace)
```
