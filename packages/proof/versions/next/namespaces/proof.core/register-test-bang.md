---
layout: reference
title: proof.core/register-test!
---
...
<li><a class="active" href="register-test-bang.html">register-test!</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">register-test!</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proof.core/register-test-bang.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proof.core.html">proof.core</a>/</div>
<h1><code>register-test!</code></h1>
</header>

<hr class="signature-divider">

```roo
(register-test! name body & namespace)
```
