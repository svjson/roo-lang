...
<li><a class="active" href="run-selected.html">run-selected</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">run-selected</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proof.core/run-selected.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proof.core.html">proof.core</a>/</div>
<h1><code>run-selected</code></h1>
</header>
