---
layout: reference
title: proof.core/current-failures
---
...
<li><a class="active" href="current-failures.html">current-failures</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">current-failures</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proof.core/current-failures.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proof.core.html">proof.core</a>/</div>
<h1><code>current-failures</code></h1>
</header>
