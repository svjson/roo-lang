---
layout: reference
title: proof.runner/absolute-test-path
---
...
<li><a class="active" href="absolute-test-path.html">absolute-test-path</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">absolute-test-path</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proof.runner/absolute-test-path.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proof.runner.html">proof.runner</a>/</div>
<h1><code>absolute-test-path</code></h1>
</header>
...
```roo
(absolute-test-path context path)
```
