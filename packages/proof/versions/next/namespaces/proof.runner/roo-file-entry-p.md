---
layout: reference
title: proof.runner/roo-file-entry?
---
...
<li><a class="active" href="roo-file-entry-p.html">roo-file-entry?</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">roo-file-entry?</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proof.runner/roo-file-entry-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proof.runner.html">proof.runner</a>/</div>
<h1><code>roo-file-entry?</code></h1>
</header>
