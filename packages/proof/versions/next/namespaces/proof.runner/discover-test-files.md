---
layout: reference
title: proof.runner/discover-test-files
---
...
<li><a class="active" href="discover-test-files.html">discover-test-files</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">discover-test-files</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proof.runner/discover-test-files.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proof.runner.html">proof.runner</a>/</div>
<h1><code>discover-test-files</code></h1>
</header>
