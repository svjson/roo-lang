---
layout: reference
title: proof.runner/relative-package-path
---
...
<li><a class="active" href="relative-package-path.html">relative-package-path</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">relative-package-path</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proof.runner/relative-package-path.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proof.runner.html">proof.runner</a>/</div>
<h1><code>relative-package-path</code></h1>
</header>
...
```roo
(relative-package-path context path)
```
