---
layout: reference
title: proof.runner/absolute-fixture-root
---
...
<ol>
<li><a class="active" href="absolute-fixture-root.html">absolute-fixture-root</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">absolute-fixture-root</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proof.runner/absolute-fixture-root.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proof.runner.html">proof.runner</a>/</div>
<h1><code>absolute-fixture-root</code></h1>
</header>
...
```roo
(absolute-fixture-root context root)
```
