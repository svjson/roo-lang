---
layout: reference
title: proof.reporter.simple/running-text
---
...
<option value="../../../{{ publication.identity }}/namespaces/proof.reporter.simple/running-text.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
