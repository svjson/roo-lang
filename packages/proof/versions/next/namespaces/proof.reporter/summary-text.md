---
layout: reference
title: proof.reporter/summary-text
---
...
<option value="../../../{{ publication.identity }}/namespaces/proof.reporter/summary-text.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
