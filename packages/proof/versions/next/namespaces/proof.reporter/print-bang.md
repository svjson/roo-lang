...
<option value="../../../{{ publication.identity }}/namespaces/proof.reporter/print-bang.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
