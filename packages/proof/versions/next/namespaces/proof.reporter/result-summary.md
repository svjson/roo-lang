---
layout: reference
title: proof.reporter/result-summary
---
...
<li><a class="active" href="result-summary.html">result-summary</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">result-summary</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proof.reporter/result-summary.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proof.reporter.html">proof.reporter</a>/</div>
<h1><code>result-summary</code></h1>
</header>
