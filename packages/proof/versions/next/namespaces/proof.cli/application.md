...
<option value="../../../{{ publication.identity }}/namespaces/proof.cli/application.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
