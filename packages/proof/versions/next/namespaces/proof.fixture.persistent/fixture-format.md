---
layout: reference
title: proof.fixture.persistent/fixture-format
---
...
<li><a class="active" href="fixture-format.html">fixture-format</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">fixture-format</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proof.fixture.persistent/fixture-format.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proof.fixture.persistent.html">proof.fixture.persistent</a>/</div>
<h1><code>fixture-format</code></h1>
</header>
