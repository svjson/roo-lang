---
layout: reference
title: proof.fixture.persistent/fixture-root
---
...
<li><a class="active" href="fixture-root.html">fixture-root</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">fixture-root</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proof.fixture.persistent/fixture-root.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proof.fixture.persistent.html">proof.fixture.persistent</a>/</div>
<h1><code>fixture-root</code></h1>
</header>
