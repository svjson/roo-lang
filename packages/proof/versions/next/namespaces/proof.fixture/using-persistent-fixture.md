---
layout: reference
title: proof.fixture/using-persistent-fixture
---
...
<li><a class="active" href="using-persistent-fixture.html">using-persistent-fixture</a></li>
</ol>
</nav>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">using-persistent-fixture</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proof.fixture/using-persistent-fixture.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proof.fixture.html">proof.fixture</a>/</div>
<h1><code>using-persistent-fixture</code></h1>
</header>
...
```roo
(using-persistent-fixture [value "bootstrap/commonborn.edn" generate]
body...)
```
