...
<option value="../../../{{ publication.identity }}/namespaces/proof.fixture/configure-bang.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
