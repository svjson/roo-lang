---
layout: reference
title: proof.fixture/cache-fixture-value
---
...
<ol>
<li><a class="active" href="cache-fixture-value.html">cache-fixture-value</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">cache-fixture-value</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proof.fixture/cache-fixture-value.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proof.fixture.html">proof.fixture</a>/</div>
<h1><code>cache-fixture-value</code></h1>
</header>
