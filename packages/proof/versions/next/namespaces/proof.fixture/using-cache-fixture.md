---
layout: reference
title: proof.fixture/using-cache-fixture
---
...
<li><a class="active" href="using-cache-fixture.html">using-cache-fixture</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">using-cache-fixture</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proof.fixture/using-cache-fixture.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proof.fixture.html">proof.fixture</a>/</div>
<h1><code>using-cache-fixture</code></h1>
</header>
...
```roo
(using-cache-fixture [value "bootstrap/commonborn" generate]
body...)
```
