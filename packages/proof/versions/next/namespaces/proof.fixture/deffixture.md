---
layout: reference
title: proof.fixture/deffixture
---
...
<li><a class="active" href="deffixture.html">deffixture</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">deffixture</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proof.fixture/deffixture.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proof.fixture.html">proof.fixture</a>/</div>
<h1><code>deffixture</code></h1>
</header>
...
```roo
(deffixture commonborn-bootstrap
{:storage :persistent
