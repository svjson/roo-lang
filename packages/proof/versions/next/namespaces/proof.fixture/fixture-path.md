---
layout: reference
title: proof.fixture/fixture-path
---
...
<option value="../../../{{ publication.identity }}/namespaces/proof.fixture/fixture-path.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
