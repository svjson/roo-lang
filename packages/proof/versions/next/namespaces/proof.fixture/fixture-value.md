---
layout: reference
title: proof.fixture/fixture-value
---
...
<li><a class="active" href="fixture-value.html">fixture-value</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">fixture-value</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proof.fixture/fixture-value.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proof.fixture.html">proof.fixture</a>/</div>
<h1><code>fixture-value</code></h1>
</header>
