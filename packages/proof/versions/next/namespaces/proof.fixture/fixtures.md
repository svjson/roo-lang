...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">fixtures</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proof.fixture/fixtures.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proof.fixture.html">proof.fixture</a>/</div>
<h1><code>fixtures</code></h1>
</header>
