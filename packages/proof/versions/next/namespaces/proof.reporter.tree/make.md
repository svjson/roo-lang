---
layout: reference
title: proof.reporter.tree/make
---
...
<option value="../../../{{ publication.identity }}/namespaces/proof.reporter.tree/make.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
