...
<option value="../../../{{ publication.identity }}/namespaces/lookup.cli/application.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
