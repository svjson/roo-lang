---
layout: reference
title: lookup.index/symbol-index
---
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.index/symbol-index.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
