---
layout: reference
title: lookup.index/symbol-index-with-roots
---
...
<li><a class="active" href="symbol-index-with-roots.html">symbol-index-with-roots</a></li>
</ol>
</nav>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">symbol-index-with-roots</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.index/symbol-index-with-roots.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.index.html">lookup.index</a>/</div>
<h1><code>symbol-index-with-roots</code></h1>
</header>
