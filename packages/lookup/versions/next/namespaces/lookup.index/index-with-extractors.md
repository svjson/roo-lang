---
layout: reference
title: lookup.index/index-with-extractors
---
...
<li><a class="active" href="index-with-extractors.html">index-with-extractors</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">index-with-extractors</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.index/index-with-extractors.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.index.html">lookup.index</a>/</div>
<h1><code>index-with-extractors</code></h1>
</header>
...
```roo
(index-with-extractors package-dir extractors)
```
