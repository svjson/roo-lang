---
layout: reference
title: lookup.source.native.parse.entries/entries!
---
...
<li><a class="active" href="entries-bang.html">entries!</a></li>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source.native.parse.entries/entries-bang.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
