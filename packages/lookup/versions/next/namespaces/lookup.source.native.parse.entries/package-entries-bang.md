---
layout: reference
title: lookup.source.native.parse.entries/package-entries!
---
...
<li><a class="active" href="package-entries-bang.html">package-entries!</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">package-entries!</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source.native.parse.entries/package-entries-bang.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.source.native.parse.entries.html">lookup.source.native.parse.entries</a>/</div>
<h1><code>package-entries!</code></h1>
</header>
