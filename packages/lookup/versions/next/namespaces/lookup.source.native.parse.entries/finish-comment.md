---
layout: reference
title: lookup.source.native.parse.entries/finish-comment
---
...
<li><a class="active" href="finish-comment.html">finish-comment</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">finish-comment</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source.native.parse.entries/finish-comment.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.source.native.parse.entries.html">lookup.source.native.parse.entries</a>/</div>
<h1><code>finish-comment</code></h1>
</header>
