---
layout: reference
title: lookup.source.native.parse.entries/indexed-lines
---
...
<li><a class="active" href="indexed-lines.html">indexed-lines</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">indexed-lines</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source.native.parse.entries/indexed-lines.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.source.native.parse.entries.html">lookup.source.native.parse.entries</a>/</div>
<h1><code>indexed-lines</code></h1>
</header>
