---
layout: reference
title: lookup.source.native.parse.entries/block-comment-start?
---
...
<li><a class="active" href="block-comment-start-p.html">block-comment-start?</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">block-comment-start?</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source.native.parse.entries/block-comment-start-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.source.native.parse.entries.html">lookup.source.native.parse.entries</a>/</div>
<h1><code>block-comment-start?</code></h1>
</header>
