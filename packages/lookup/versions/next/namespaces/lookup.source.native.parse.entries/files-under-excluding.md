---
layout: reference
title: lookup.source.native.parse.entries/files-under-excluding
---
...
<li><a class="active" href="files-under-excluding.html">files-under-excluding</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">files-under-excluding</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source.native.parse.entries/files-under-excluding.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.source.native.parse.entries.html">lookup.source.native.parse.entries</a>/</div>
<h1><code>files-under-excluding</code></h1>
</header>

<hr class="signature-divider">

```roo
(files-under-excluding root excludes)
```
