---
layout: reference
title: lookup.source/package-contributions
---
...
<li><a class="active" href="package-contributions.html">package-contributions</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">package-contributions</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source/package-contributions.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.source.html">lookup.source</a>/</div>
<h1><code>package-contributions</code></h1>
</header>
...
```roo
(package-contributions package-dir package)
```
