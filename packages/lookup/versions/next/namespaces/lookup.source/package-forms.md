---
layout: reference
title: lookup.source/package-forms
---
...
<li><a class="active" href="package-forms.html">package-forms</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">package-forms</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source/package-forms.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.source.html">lookup.source</a>/</div>
<h1><code>package-forms</code></h1>
</header>
