---
layout: reference
title: lookup.source/native-contributions
---
...
<li><a class="active" href="native-contributions.html">native-contributions</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">native-contributions</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source/native-contributions.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.source.html">lookup.source</a>/</div>
<h1><code>native-contributions</code></h1>
</header>
