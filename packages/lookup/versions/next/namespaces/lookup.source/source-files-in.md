---
layout: reference
title: lookup.source/source-files-in
---
...
<li><a class="active" href="source-files-in.html">source-files-in</a></li>
</ol>
</nav>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">source-files-in</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source/source-files-in.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.source.html">lookup.source</a>/</div>
<h1><code>source-files-in</code></h1>
</header>
