---
layout: reference
title: lookup.source/root-symbols
---
...
<li><a class="active" href="root-symbols.html">root-symbols</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">root-symbols</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source/root-symbols.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.source.html">lookup.source</a>/</div>
<h1><code>root-symbols</code></h1>
</header>
