---
layout: reference
title: lookup.source/package-source-files
---
...
<li><a class="active" href="package-source-files.html">package-source-files</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">package-source-files</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source/package-source-files.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.source.html">lookup.source</a>/</div>
<h1><code>package-source-files</code></h1>
</header>
...
```roo
(package-source-files package-dir manifest)
```
