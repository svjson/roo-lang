---
layout: reference
title: lookup.source/package-load-roots
---
...
<li><a class="active" href="package-load-roots.html">package-load-roots</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">package-load-roots</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source/package-load-roots.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.source.html">lookup.source</a>/</div>
<h1><code>package-load-roots</code></h1>
</header>
