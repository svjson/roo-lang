---
layout: reference
title: lookup.source/roo-contribution
---
...
<li><a class="active" href="roo-contribution.html">roo-contribution</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">roo-contribution</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source/roo-contribution.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.source.html">lookup.source</a>/</div>
<h1><code>roo-contribution</code></h1>
</header>
