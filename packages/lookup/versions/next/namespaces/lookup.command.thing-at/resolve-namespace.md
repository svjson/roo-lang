---
layout: reference
title: lookup.command.thing-at/resolve-namespace
---
...
<li><a class="active" href="resolve-namespace.html">resolve-namespace</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">resolve-namespace</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.command.thing-at/resolve-namespace.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.command.thing-at.html">lookup.command.thing-at</a>/</div>
<h1><code>resolve-namespace</code></h1>
</header>

<hr class="signature-divider">

```roo
(resolve-namespace package-dir name)
```
