---
layout: reference
title: lookup.source.docstring.parse.content/SECTION-TARGETS
---
...
<ol>
<li><a class="active" href="section-targets.html">SECTION-TARGETS</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">SECTION-TARGETS</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source.docstring.parse.content/section-targets.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
...
<h1><code>SECTION-TARGETS</code></h1>
</header>
