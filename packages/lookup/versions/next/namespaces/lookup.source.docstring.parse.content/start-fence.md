---
layout: reference
title: lookup.source.docstring.parse.content/start-fence
---
...
<li><a class="active" href="start-fence.html">start-fence</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">start-fence</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source.docstring.parse.content/start-fence.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
...
<h1><code>start-fence</code></h1>
</header>

<hr class="signature-divider">

```roo
(start-fence state line)
```
