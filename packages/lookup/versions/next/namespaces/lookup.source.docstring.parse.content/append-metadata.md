---
layout: reference
title: lookup.source.docstring.parse.content/append-metadata
---
...
<li><a class="active" href="append-metadata.html">append-metadata</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">append-metadata</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source.docstring.parse.content/append-metadata.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
...
<h1><code>append-metadata</code></h1>
</header>

<hr class="signature-divider">

```roo
(append-metadata state key line)
```
