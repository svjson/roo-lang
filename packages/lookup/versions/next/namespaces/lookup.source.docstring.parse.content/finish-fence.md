---
layout: reference
title: lookup.source.docstring.parse.content/finish-fence
---
...
<li><a class="active" href="finish-fence.html">finish-fence</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">finish-fence</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source.docstring.parse.content/finish-fence.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
...
<h1><code>finish-fence</code></h1>
</header>

<hr class="signature-divider">

```roo
(finish-fence {:keys [fence] :as state})
```
