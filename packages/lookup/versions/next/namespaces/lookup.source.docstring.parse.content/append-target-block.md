---
layout: reference
title: lookup.source.docstring.parse.content/append-target-block
---
...
<li><a class="active" href="append-target-block.html">append-target-block</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">append-target-block</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source.docstring.parse.content/append-target-block.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
...
<h1><code>append-target-block</code></h1>
</header>

<hr class="signature-divider">

```roo
(append-target-block state block)
```
