---
layout: reference
title: lookup.source.docstring.parse.content/arg-declaration
---
...
<li><a class="active" href="arg-declaration.html">arg-declaration</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">arg-declaration</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source.docstring.parse.content/arg-declaration.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
...
<h1><code>arg-declaration</code></h1>
</header>

<hr class="signature-divider">

```roo
(arg-declaration line param-names)
```
