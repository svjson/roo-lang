---
layout: reference
title: lookup.source.docstring.parse.content/finish-text
---
...
<li><a class="active" href="finish-text.html">finish-text</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">finish-text</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source.docstring.parse.content/finish-text.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
...
<h1><code>finish-text</code></h1>
</header>

<hr class="signature-divider">

```roo
(finish-text {:keys [text-lines] :as state})
```
