---
layout: reference
title: lookup.source.docstring.parse.content/fence-language
---
...
<li><a class="active" href="fence-language.html">fence-language</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">fence-language</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source.docstring.parse.content/fence-language.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
...
<h1><code>fence-language</code></h1>
</header>
