---
layout: reference
title: lookup.command.audit/diagnostic-extra
---
...
<li><a class="active" href="diagnostic-extra.html">diagnostic-extra</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">diagnostic-extra</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.command.audit/diagnostic-extra.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.command.audit.html">lookup.command.audit</a>/</div>
<h1><code>diagnostic-extra</code></h1>
</header>
