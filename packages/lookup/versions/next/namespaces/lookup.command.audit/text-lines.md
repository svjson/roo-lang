---
layout: reference
title: lookup.command.audit/text-lines
---
...
<li><a class="active" href="text-lines.html">text-lines</a></li>
</ol>
</nav>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">text-lines</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.command.audit/text-lines.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.command.audit.html">lookup.command.audit</a>/</div>
<h1><code>text-lines</code></h1>
</header>
