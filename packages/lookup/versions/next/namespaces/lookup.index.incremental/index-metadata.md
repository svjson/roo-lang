---
layout: reference
title: lookup.index.incremental/INDEX-METADATA
---
...
<ol>
<li><a class="active" href="index-metadata.html">INDEX-METADATA</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">INDEX-METADATA</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.index.incremental/index-metadata.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.index.incremental.html">lookup.index.incremental</a>/</div>
<h1><code>INDEX-METADATA</code></h1>
</header>
