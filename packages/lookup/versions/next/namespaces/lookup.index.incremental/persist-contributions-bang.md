---
layout: reference
title: lookup.index.incremental/persist-contributions!
---
...
<li><a class="active" href="persist-contributions-bang.html">persist-contributions!</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">persist-contributions!</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.index.incremental/persist-contributions-bang.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.index.incremental.html">lookup.index.incremental</a>/</div>
<h1><code>persist-contributions!</code></h1>
</header>
...
```roo
(persist-contributions! state-dir revision contributions)
```
