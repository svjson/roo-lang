---
layout: reference
title: lookup.index.incremental/full-build!
---
...
<li><a class="active" href="full-build-bang.html">full-build!</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">full-build!</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.index.incremental/full-build-bang.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.index.incremental.html">lookup.index.incremental</a>/</div>
<h1><code>full-build!</code></h1>
</header>
...
```roo
(full-build! metadata options state-dir base-revision)
```
