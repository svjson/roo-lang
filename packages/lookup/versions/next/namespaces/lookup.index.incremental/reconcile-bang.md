---
layout: reference
title: lookup.index.incremental/reconcile!
---
...
<li><a class="active" href="reconcile-bang.html">reconcile!</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">reconcile!</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.index.incremental/reconcile-bang.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.index.incremental.html">lookup.index.incremental</a>/</div>
<h1><code>reconcile!</code></h1>
</header>
...
```roo
(reconcile! metadata options state-dir manifest)
```
