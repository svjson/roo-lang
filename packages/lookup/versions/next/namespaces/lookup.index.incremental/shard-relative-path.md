---
layout: reference
title: lookup.index.incremental/shard-relative-path
---
...
<li><a class="active" href="shard-relative-path.html">shard-relative-path</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">shard-relative-path</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.index.incremental/shard-relative-path.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.index.incremental.html">lookup.index.incremental</a>/</div>
<h1><code>shard-relative-path</code></h1>
</header>
...
```roo
(shard-relative-path id revision)
```
