---
layout: reference
title: lookup.index.incremental/manifest-snapshot
---
...
<li><a class="active" href="manifest-snapshot.html">manifest-snapshot</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">manifest-snapshot</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.index.incremental/manifest-snapshot.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.index.incremental.html">lookup.index.incremental</a>/</div>
<h1><code>manifest-snapshot</code></h1>
</header>
...
```roo
(manifest-snapshot state-dir manifest)
```
