---
layout: reference
title: lookup.index.incremental/compatible-state?
---
...
<li><a class="active" href="compatible-state-p.html">compatible-state?</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">compatible-state?</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.index.incremental/compatible-state-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.index.incremental.html">lookup.index.incremental</a>/</div>
<h1><code>compatible-state?</code></h1>
</header>
...
```roo
(compatible-state? metadata manifest options)
```
