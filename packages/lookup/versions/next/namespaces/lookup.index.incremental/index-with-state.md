---
layout: reference
title: lookup.index.incremental/index-with-state
---
...
<li><a class="active" href="index-with-state.html">index-with-state</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">index-with-state</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.index.incremental/index-with-state.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.index.incremental.html">lookup.index.incremental</a>/</div>
<h1><code>index-with-state</code></h1>
</header>
