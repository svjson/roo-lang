---
layout: reference
title: lookup.source.native.parse.comment/append-annotation-text
---
...
<li><a class="active" href="append-annotation-text.html">append-annotation-text</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">append-annotation-text</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source.native.parse.comment/append-annotation-text.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.source.native.parse.comment.html">lookup.source.native.parse.comment</a>/</div>
<h1><code>append-annotation-text</code></h1>
</header>

<hr class="signature-divider">

```roo
(append-annotation-text current value)
```
