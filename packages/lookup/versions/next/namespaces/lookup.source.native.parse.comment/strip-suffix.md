---
layout: reference
title: lookup.source.native.parse.comment/strip-suffix
---
...
<li><a class="active" href="strip-suffix.html">strip-suffix</a></li>
</ol>
</nav>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">strip-suffix</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source.native.parse.comment/strip-suffix.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.source.native.parse.comment.html">lookup.source.native.parse.comment</a>/</div>
<h1><code>strip-suffix</code></h1>
</header>

<hr class="signature-divider">

```roo
(strip-suffix text suffix)
```
