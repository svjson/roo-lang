---
layout: reference
title: lookup.source.native.parse.comment/directive-value
---
...
<li><a class="active" href="directive-value.html">directive-value</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">directive-value</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source.native.parse.comment/directive-value.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.source.native.parse.comment.html">lookup.source.native.parse.comment</a>/</div>
<h1><code>directive-value</code></h1>
</header>

<hr class="signature-divider">

```roo
(directive-value line directive)
```
