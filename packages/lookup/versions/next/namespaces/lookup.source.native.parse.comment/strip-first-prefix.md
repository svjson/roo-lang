---
layout: reference
title: lookup.source.native.parse.comment/strip-first-prefix
---
...
<li><a class="active" href="strip-first-prefix.html">strip-first-prefix</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">strip-first-prefix</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source.native.parse.comment/strip-first-prefix.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.source.native.parse.comment.html">lookup.source.native.parse.comment</a>/</div>
<h1><code>strip-first-prefix</code></h1>
</header>

<hr class="signature-divider">

```roo
(strip-first-prefix text prefixes)
```
