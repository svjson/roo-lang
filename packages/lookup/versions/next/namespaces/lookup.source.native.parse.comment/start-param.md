---
layout: reference
title: lookup.source.native.parse.comment/start-param
---
...
<li><a class="active" href="start-param.html">start-param</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">start-param</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source.native.parse.comment/start-param.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.source.native.parse.comment.html">lookup.source.native.parse.comment</a>/</div>
<h1><code>start-param</code></h1>
</header>

<hr class="signature-divider">

```roo
(start-param state name content)
```
