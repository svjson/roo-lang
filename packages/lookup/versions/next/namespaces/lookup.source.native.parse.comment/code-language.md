---
layout: reference
title: lookup.source.native.parse.comment/code-language
---
...
<li><a class="active" href="code-language.html">code-language</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">code-language</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source.native.parse.comment/code-language.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.source.native.parse.comment.html">lookup.source.native.parse.comment</a>/</div>
<h1><code>code-language</code></h1>
</header>

<hr class="signature-divider">

```roo
(code-language line offset)
```
