---
layout: reference
title: lookup.source.native.parse.comment/reuse-single-return
---
...
<li><a class="active" href="reuse-single-return.html">reuse-single-return</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">reuse-single-return</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source.native.parse.comment/reuse-single-return.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.source.native.parse.comment.html">lookup.source.native.parse.comment</a>/</div>
<h1><code>reuse-single-return</code></h1>
</header>

<hr class="signature-divider">

```roo
(reuse-single-return state)
```
