---
layout: reference
title: lookup.source.native.parse.comment/return-text
---
...
<li><a class="active" href="return-text.html">return-text</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">return-text</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source.native.parse.comment/return-text.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.source.native.parse.comment.html">lookup.source.native.parse.comment</a>/</div>
<h1><code>return-text</code></h1>
</header>
