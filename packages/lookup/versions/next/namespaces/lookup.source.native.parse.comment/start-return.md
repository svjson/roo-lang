---
layout: reference
title: lookup.source.native.parse.comment/start-return
---
...
<li><a class="active" href="start-return.html">start-return</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">start-return</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source.native.parse.comment/start-return.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.source.native.parse.comment.html">lookup.source.native.parse.comment</a>/</div>
<h1><code>start-return</code></h1>
</header>

<hr class="signature-divider">

```roo
(start-return state content)
```
