---
layout: reference
title: lookup.source.native.parse.comment/param-directive
---
...
<li><a class="active" href="param-directive.html">param-directive</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">param-directive</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source.native.parse.comment/param-directive.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.source.native.parse.comment.html">lookup.source.native.parse.comment</a>/</div>
<h1><code>param-directive</code></h1>
</header>

<hr class="signature-divider">

```roo
(param-directive line)
```
