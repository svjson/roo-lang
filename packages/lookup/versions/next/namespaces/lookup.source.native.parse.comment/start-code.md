---
layout: reference
title: lookup.source.native.parse.comment/start-code
---
...
<li><a class="active" href="start-code.html">start-code</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">start-code</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/lookup.source.native.parse.comment/start-code.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../lookup.source.native.parse.comment.html">lookup.source.native.parse.comment</a>/</div>
<h1><code>start-code</code></h1>
</header>

<hr class="signature-divider">

```roo
(start-code state language end-marker)
```
