---
layout: reference
title: boodle.format.github-pages/namespace-document
---
...
<li><a class="active" href="namespace-document.html">namespace-document</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">namespace-document</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/namespace-document.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>namespace-document</code></h1>
</header>
...
```roo
(namespace-document {:keys [namespace]})
```
