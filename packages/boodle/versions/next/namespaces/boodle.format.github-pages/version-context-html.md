---
layout: reference
title: boodle.format.github-pages/version-context-html
---
...
<li><a class="active" href="version-context-html.html">version-context-html</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">version-context-html</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/version-context-html.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>version-context-html</code></h1>
</header>

Return visible package version context for PAGE.

<hr class="signature-divider">

```roo
(version-context-html page)
```
...
HTML context for versioned package pages, or an empty string.
