---
layout: reference
title: boodle.format.github-pages/navigation-html
---
...
<li><a class="active" href="navigation-html.html">navigation-html</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">navigation-html</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/navigation-html.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>navigation-html</code></h1>
</header>

Return hierarchy navigation HTML for PAGE.
...
Navigation markup selected by the catalog navigation style.
