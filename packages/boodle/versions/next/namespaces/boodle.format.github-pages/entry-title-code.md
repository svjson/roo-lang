---
layout: reference
title: boodle.format.github-pages/entry-title-code
---
...
<li><a class="active" href="entry-title-code.html">entry-title-code</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">entry-title-code</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/entry-title-code.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>entry-title-code</code></h1>
</header>

Return ENTRY display title as Markdown inline code text.
...
Markdown code span text for the local symbol name.
