---
layout: reference
title: boodle.format.github-pages/symbol-document
---
...
<li><a class="active" href="symbol-document.html">symbol-document</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">symbol-document</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/symbol-document.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>symbol-document</code></h1>
</header>

Return the GitHub Pages symbol document for PAGE.

<hr class="signature-divider">

```roo
(symbol-document {:keys [entry] :as page})
```
