---
layout: reference
title: boodle.format.github-pages/version-selector-html
---
...
<li><a class="active" href="version-selector-html.html">version-selector-html</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">version-selector-html</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/version-selector-html.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>version-selector-html</code></h1>
</header>

Return package version selector HTML for PAGE.

<hr class="signature-divider">

```roo
(version-selector-html {:keys [package] :as page})
```
...
| Arg                        | Description |
| -------------------------- | ----------- |
| {:keys [package] :as page} |             |

### Returns:

HTML allowing navigation between materialized package versions.

- `page`: Boodle versioned reference page.
