---
layout: reference
title: boodle.format.github-pages/breadcrumb-item-html
---
...
<ol>
<li><a class="active" href="breadcrumb-item-html.html">breadcrumb-item-html</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">breadcrumb-item-html</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/breadcrumb-item-html.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>breadcrumb-item-html</code></h1>
</header>

Return breadcrumb HTML for ITEM.

<hr class="signature-divider">

```roo
(breadcrumb-item-html item)
```
...
| Arg  | Description          |
| ---- | -------------------- |
| item | Breadcrumb item map. |

### Returns:

HTML for a linked or current breadcrumb item.
