---
layout: reference
title: boodle.format.github-pages/sidebar-symbol-url
---
...
<li><a class="active" href="sidebar-symbol-url.html">sidebar-symbol-url</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">sidebar-symbol-url</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/sidebar-symbol-url.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>sidebar-symbol-url</code></h1>
</header>

Return the URL for ENTRY from PAGE.

<hr class="signature-divider">

```roo
(sidebar-symbol-url page entry)
```
