---
layout: reference
title: boodle.format.github-pages/page-title
---
...
<li><a class="active" href="page-title.html">page-title</a></li>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/page-title.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
