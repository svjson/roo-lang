---
layout: reference
title: boodle.format.github-pages/version-page-url
---
...
<li><a class="active" href="version-page-url.html">version-page-url</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">version-page-url</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/version-page-url.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>version-page-url</code></h1>
</header>

Return the URL for VERSION from PAGE.

<hr class="signature-divider">

```roo
(version-page-url page version)
```
...
Relative URL to the matching page in VERSION.
