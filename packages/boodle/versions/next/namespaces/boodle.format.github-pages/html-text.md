---
layout: reference
title: boodle.format.github-pages/html-text
---
...
<li><a class="active" href="html-text.html">html-text</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">html-text</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/html-text.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>html-text</code></h1>
</header>

Escape VALUE for generated HTML.
...
| Arg   | Description                    |
| ----- | ------------------------------ |
| value | Text value to include in HTML. |
