---
layout: reference
title: boodle.format.github-pages/unplaced-signature-blocks
---
...
<li><a class="active" href="unplaced-signature-blocks.html">unplaced-signature-blocks</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">unplaced-signature-blocks</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/unplaced-signature-blocks.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>unplaced-signature-blocks</code></h1>
</header>

Render signature arguments that have no source occurrence block.

<hr class="signature-divider">

```roo
(unplaced-signature-blocks entry)
```
...
| Arg   | Description                                       |
| ----- | ------------------------------------------------- |
| entry | Boodle entry with signatures and ordered content. |

### Returns:

Moordown blocks for signatures not selected by any `:sig-args` block.
