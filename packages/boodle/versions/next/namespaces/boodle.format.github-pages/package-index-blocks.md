---
layout: reference
title: boodle.format.github-pages/package-index-blocks
---
...
<li><a class="active" href="package-index-blocks.html">package-index-blocks</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">package-index-blocks</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/package-index-blocks.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>package-index-blocks</code></h1>
</header>

Return package blocks for the root index.

<hr class="signature-divider">

```roo
(package-index-blocks packages groups)
```
...
| Arg      | Description                  |
| -------- | ---------------------------- |
| packages | Catalog package maps.        |
| groups   | Optional package group maps. |

### Returns:

Either grouped package sections or one flat package table.
