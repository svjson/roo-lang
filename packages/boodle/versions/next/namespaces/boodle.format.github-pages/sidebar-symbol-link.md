---
layout: reference
title: boodle.format.github-pages/sidebar-symbol-link
---
...
<li><a class="active" href="sidebar-symbol-link.html">sidebar-symbol-link</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">sidebar-symbol-link</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/sidebar-symbol-link.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>sidebar-symbol-link</code></h1>
</header>

Return a sidebar link for ENTRY from PAGE.

<hr class="signature-divider">

```roo
(sidebar-symbol-link page entry)
```
...
| Arg   | Description                      |
| ----- | -------------------------------- |
| page  | Boodle namespace or symbol page. |
| entry | Boodle entry map.                |

### Returns:

HTML list item for one sidebar symbol link.
