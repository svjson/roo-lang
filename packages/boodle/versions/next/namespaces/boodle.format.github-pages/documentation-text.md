---
layout: reference
title: boodle.format.github-pages/documentation-text
---
...
<li><a class="active" href="documentation-text.html">documentation-text</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">documentation-text</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/documentation-text.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>documentation-text</code></h1>
</header>

Return block content as text for compact documentation contexts.
...
Nonempty block content joined by blank lines.
