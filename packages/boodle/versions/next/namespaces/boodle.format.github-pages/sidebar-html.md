---
layout: reference
title: boodle.format.github-pages/sidebar-html
---
...
<li><a class="active" href="sidebar-html.html">sidebar-html</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">sidebar-html</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/sidebar-html.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>sidebar-html</code></h1>
</header>

Return namespace sidebar HTML for PAGE.

<hr class="signature-divider">

```roo
(sidebar-html {:keys [namespace] :as page})
```
...
| Arg                          | Description |
| ---------------------------- | ----------- |
| {:keys [namespace] :as page} |             |

### Returns:

HTML navigation listing all symbols in the page namespace.
