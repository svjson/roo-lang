---
layout: reference
title: boodle.format.github-pages/package-index-document
---
...
<li><a class="active" href="package-index-document.html">package-index-document</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">package-index-document</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/package-index-document.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>package-index-document</code></h1>
</header>

Return the GitHub Pages package redirect document for PAGE.

<hr class="signature-divider">

```roo
(package-index-document {:keys [package]})
```
