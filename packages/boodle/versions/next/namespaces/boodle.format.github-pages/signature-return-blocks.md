---
layout: reference
title: boodle.format.github-pages/signature-return-blocks
---
...
<li><a href="package-index-url.html">package-index-url</a></li>
...
<li><a class="active" href="signature-return-blocks.html">signature-return-blocks</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">signature-return-blocks</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/signature-return-blocks.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>signature-return-blocks</code></h1>
</header>

Return Markdown blocks for a signature's documented return value.

<hr class="signature-divider">

```roo
(signature-return-blocks entry signature)
```
...
| Arg       | Description                            |
| --------- | -------------------------------------- |
| entry     | Boodle entry containing the signature. |
| signature | Lookup-style signature map.            |

### Returns:

A Returns heading and its ordered content, or an empty vector.
