---
layout: reference
title: boodle.format.github-pages/symbol-heading-html
---
...
<li><a class="active" href="symbol-heading-html.html">symbol-heading-html</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">symbol-heading-html</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/symbol-heading-html.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>symbol-heading-html</code></h1>
</header>

Return the symbol heading and compact metadata for PAGE.

<hr class="signature-divider">

```roo
(symbol-heading-html {:keys [entry namespace]})
```
...
HTML containing a linked namespace eyebrow, symbol title, and any `:since`
or `:see` metadata.

- `page`: Boodle symbol page map.
