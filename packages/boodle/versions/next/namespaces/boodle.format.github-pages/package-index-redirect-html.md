---
layout: reference
title: boodle.format.github-pages/package-index-redirect-html
---
...
<li><a class="active" href="package-index-redirect-html.html">package-index-redirect-html</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">package-index-redirect-html</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/package-index-redirect-html.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>package-index-redirect-html</code></h1>
</header>

Return redirect markup for PAGE.

<hr class="signature-divider">

```roo
(package-index-redirect-html page)
```
...
| Arg  | Description                |
| ---- | -------------------------- |
| page | Boodle package index page. |

### Returns:

HTML and fallback Markdown linking to the current package version.
