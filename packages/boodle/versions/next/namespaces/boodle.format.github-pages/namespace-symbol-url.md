---
layout: reference
title: boodle.format.github-pages/namespace-symbol-url
---
...
<li><a class="active" href="namespace-symbol-url.html">namespace-symbol-url</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">namespace-symbol-url</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/namespace-symbol-url.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>namespace-symbol-url</code></h1>
</header>

Return the symbol page URL from a namespace overview page.

<hr class="signature-divider">

```roo
(namespace-symbol-url namespace entry)
```
...
Relative URL from the namespace overview page to the symbol page.
