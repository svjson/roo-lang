---
layout: reference
title: boodle.format.github-pages/package-url
---
...
<li><a class="active" href="package-url.html">package-url</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">package-url</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/package-url.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>package-url</code></h1>
</header>

Return the root index URL for PACKAGE.
...
URL to the package entrypoint for publication-aware catalogs, otherwise the
directly rendered package version.
