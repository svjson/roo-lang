---
layout: reference
title: boodle.format.github-pages/reference-content
---
...
<li><a class="active" href="reference-content.html">reference-content</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">reference-content</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/reference-content.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>reference-content</code></h1>
</header>

Return rendered content for PAGE.
...
Markdown or HTML/Markdown content for the page body.
