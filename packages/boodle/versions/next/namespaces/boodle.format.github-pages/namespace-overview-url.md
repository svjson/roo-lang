---
layout: reference
title: boodle.format.github-pages/namespace-overview-url
---
...
<li><a class="active" href="namespace-overview-url.html">namespace-overview-url</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">namespace-overview-url</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/namespace-overview-url.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>namespace-overview-url</code></h1>
</header>

Return the namespace overview URL from PAGE.

<hr class="signature-divider">

```roo
(namespace-overview-url page)
```
...
Relative URL to the namespace overview page.
