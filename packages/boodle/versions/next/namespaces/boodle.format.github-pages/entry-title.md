---
layout: reference
title: boodle.format.github-pages/entry-title
---
...
<li><a class="active" href="entry-title.html">entry-title</a></li>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/entry-title.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
...
Return the display title for ENTRY.
...
Local symbol name when available, otherwise the qualified name.
