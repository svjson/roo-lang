---
layout: reference
title: boodle.format.github-pages/layout-content
---
...
<li><a class="active" href="layout-content.html">layout-content</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">layout-content</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/layout-content.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>layout-content</code></h1>
</header>

Jekyll layout used by generated reference pages.
