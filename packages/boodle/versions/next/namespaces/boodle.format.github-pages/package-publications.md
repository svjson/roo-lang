---
layout: reference
title: boodle.format.github-pages/package-publications
---
...
<li><a class="active" href="package-publications.html">package-publications</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">package-publications</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/package-publications.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>package-publications</code></h1>
</header>

Return known publications for PACKAGE.
...
Classified publication maps in public navigation order.
