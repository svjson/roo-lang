---
layout: reference
title: boodle.format.github-pages/package-table
---
...
<li><a class="active" href="package-table.html">package-table</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">package-table</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/package-table.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>package-table</code></h1>
</header>

Return a package table block for PACKAGES.
