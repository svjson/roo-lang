---
layout: reference
title: boodle.format.github-pages/signature-args-blocks
---
...
<li><a class="active" href="signature-args-blocks.html">signature-args-blocks</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">signature-args-blocks</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/signature-args-blocks.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>signature-args-blocks</code></h1>
</header>

Return Markdown blocks for a signature's argument declaration.

<hr class="signature-divider">

```roo
(signature-args-blocks signature)
```
...
Blocks containing a Signature heading, rendered call shape, and parameter
table.
