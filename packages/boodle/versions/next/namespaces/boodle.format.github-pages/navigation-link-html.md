---
layout: reference
title: boodle.format.github-pages/navigation-link-html
---
...
<li><a class="active" href="navigation-link-html.html">navigation-link-html</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">navigation-link-html</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/navigation-link-html.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>navigation-link-html</code></h1>
</header>

Return an HTML link for navigation ITEM.

<hr class="signature-divider">

```roo
(navigation-link-html item)
```
