---
layout: reference
title: boodle.format.github-pages/package-section-blocks
---
...
<li><a class="active" href="package-section-blocks.html">package-section-blocks</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">package-section-blocks</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/package-section-blocks.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>package-section-blocks</code></h1>
</header>

Return root index blocks for TITLE and PACKAGES.

<hr class="signature-divider">

```roo
(package-section-blocks title packages)
```
...
| packages | Boodle package maps.  |

### Returns:

Heading and package table blocks, or an empty vector when PACKAGES is empty.
