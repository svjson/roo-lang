---
layout: reference
title: boodle.format.github-pages/breadcrumb-items-html
---
...
<li><a class="active" href="breadcrumb-items-html.html">breadcrumb-items-html</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">breadcrumb-items-html</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/breadcrumb-items-html.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>breadcrumb-items-html</code></h1>
</header>

Return HTML for breadcrumb ITEMS.
...
| Arg   | Description           |
| ----- | --------------------- |
| items | Breadcrumb item maps. |

### Returns:

HTML for breadcrumb items separated by hierarchy marks.
