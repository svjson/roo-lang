---
layout: reference
title: boodle.format.github-pages/publication-data-content
---
...
<li><a class="active" href="publication-data-content.html">publication-data-content</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">publication-data-content</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/publication-data-content.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>publication-data-content</code></h1>
</header>

Render the shared publication catalog as Jekyll data.

<hr class="signature-divider">

```roo
(publication-data-content catalog)
```
...
| Arg     | Description                                          |
| ------- | ---------------------------------------------------- |
| catalog | Boodle catalog with classified package publications. |

### Returns:

YAML containing ordered publications and automatic selections by package.
