---
layout: reference
title: boodle.format.github-pages/yaml-text
---
...
<li><a class="active" href="yaml-text.html">yaml-text</a></li>
</ol>
</nav>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">yaml-text</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/yaml-text.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>yaml-text</code></h1>
</header>

Quote TEXT for the generated publication-data YAML.
