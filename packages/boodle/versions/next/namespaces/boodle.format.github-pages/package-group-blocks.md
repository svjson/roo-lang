---
layout: reference
title: boodle.format.github-pages/package-group-blocks
---
...
<li><a class="active" href="package-group-blocks.html">package-group-blocks</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">package-group-blocks</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/package-group-blocks.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>package-group-blocks</code></h1>
</header>

Return root index blocks for GROUP.

<hr class="signature-divider">

```roo
(package-group-blocks packages group)
```
...
Heading and package table blocks for the packages named by GROUP.
