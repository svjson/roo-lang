---
layout: reference
title: boodle.format.github-pages/up-navigation-html
---
...
<li><a class="active" href="up-navigation-html.html">up-navigation-html</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">up-navigation-html</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/up-navigation-html.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>up-navigation-html</code></h1>
</header>

Return upward navigation HTML for PAGE.

<hr class="signature-divider">

```roo
(up-navigation-html page)
```
...
Upward navigation markup, or an empty string.
