---
layout: reference
title: boodle.format.github-pages/files
---
...
<li><a class="active" href="files.html">files</a></li>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/files.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>files</code></h1>
</header>
