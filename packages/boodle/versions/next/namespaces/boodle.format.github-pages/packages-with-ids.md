---
layout: reference
title: boodle.format.github-pages/packages-with-ids
---
...
<li><a class="active" href="packages-with-ids.html">packages-with-ids</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">packages-with-ids</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/packages-with-ids.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>packages-with-ids</code></h1>
</header>

Return PACKAGES matching IDS in IDS order.

<hr class="signature-divider">

```roo
(packages-with-ids packages ids)
```
