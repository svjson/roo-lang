---
layout: reference
title: boodle.format.github-pages/breadcrumbs-html
---
...
<li><a class="active" href="breadcrumbs-html.html">breadcrumbs-html</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">breadcrumbs-html</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/breadcrumbs-html.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>breadcrumbs-html</code></h1>
</header>

Return breadcrumb navigation HTML for PAGE.

<hr class="signature-divider">

```roo
(breadcrumbs-html page)
```
...
Breadcrumb navigation markup, or an empty string.
