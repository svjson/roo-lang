---
layout: reference
title: boodle.format.github-pages/stylesheet-content
---
...
<li><a class="active" href="stylesheet-content.html">stylesheet-content</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">stylesheet-content</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/stylesheet-content.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>stylesheet-content</code></h1>
</header>

CSS used by generated reference pages.
