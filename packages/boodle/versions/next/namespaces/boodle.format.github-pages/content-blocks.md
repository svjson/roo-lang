---
layout: reference
title: boodle.format.github-pages/content-blocks
---
...
<li><a class="active" href="content-blocks.html">content-blocks</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">content-blocks</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/content-blocks.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>content-blocks</code></h1>
</header>

Convert ordered documentation blocks to Moordown blocks.
...
| Arg    | Description                                                     |
| ------ | --------------------------------------------------------------- |
| entry  | Boodle entry or namespace containing any referenced signatures. |
| blocks | Ordered documentation blocks.                                   |

### Returns:

Moordown blocks in source order.
