---
layout: reference
title: boodle.format.github-pages/package-with-id
---
...
<li><a class="active" href="package-with-id.html">package-with-id</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">package-with-id</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.github-pages/package-with-id.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.github-pages.html">boodle.format.github-pages</a>/</div>
<h1><code>package-with-id</code></h1>
</header>

Return the package with ID from PACKAGES.

<hr class="signature-divider">

```roo
(package-with-id packages id)
```
...
| id       | Package id to find.  |

### Returns:

Matching package map, or nil.
