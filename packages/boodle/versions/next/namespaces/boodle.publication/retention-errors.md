---
layout: reference
title: boodle.publication/retention-errors
---
...
<li><a class="active" href="retention-errors.html">retention-errors</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">retention-errors</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.publication/retention-errors.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.publication.html">boodle.publication</a>/</div>
<h1><code>retention-errors</code></h1>
</header>
...
```roo
(retention-errors publication identities)
```
