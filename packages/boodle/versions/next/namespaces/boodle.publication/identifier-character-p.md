---
layout: reference
title: boodle.publication/identifier-character?
---
...
<li><a class="active" href="identifier-character-p.html">identifier-character?</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">identifier-character?</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.publication/identifier-character-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.publication.html">boodle.publication</a>/</div>
<h1><code>identifier-character?</code></h1>
</header>
