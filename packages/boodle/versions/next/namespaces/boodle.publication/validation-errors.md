---
layout: reference
title: boodle.publication/validation-errors
---
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.publication/validation-errors.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
...
| Arg     | Description                                                                     |
| ------- | ------------------------------------------------------------------------------- |
| options | Generate options containing `:publication-mode` and<br>`:publication-identity`. |
