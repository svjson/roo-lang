---
layout: reference
title: boodle.publication/classify
---
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.publication/classify.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
