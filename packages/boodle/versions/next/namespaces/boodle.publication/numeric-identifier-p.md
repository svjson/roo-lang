---
layout: reference
title: boodle.publication/numeric-identifier?
---
...
<li><a class="active" href="numeric-identifier-p.html">numeric-identifier?</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">numeric-identifier?</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.publication/numeric-identifier-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.publication.html">boodle.publication</a>/</div>
<h1><code>numeric-identifier?</code></h1>
</header>
