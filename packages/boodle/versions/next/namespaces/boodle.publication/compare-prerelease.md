---
layout: reference
title: boodle.publication/compare-prerelease
---
...
<li><a class="active" href="compare-prerelease.html">compare-prerelease</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">compare-prerelease</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.publication/compare-prerelease.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.publication.html">boodle.publication</a>/</div>
<h1><code>compare-prerelease</code></h1>
</header>
