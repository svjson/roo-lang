---
layout: reference
title: boodle.publication/automatic
---
...
<li><a class="active" href="automatic.html">automatic</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">automatic</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.publication/automatic.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
