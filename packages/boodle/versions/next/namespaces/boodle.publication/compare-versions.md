---
layout: reference
title: boodle.publication/compare-versions
---
...
<li><a class="active" href="compare-versions.html">compare-versions</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">compare-versions</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.publication/compare-versions.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.publication.html">boodle.publication</a>/</div>
<h1><code>compare-versions</code></h1>
</header>
