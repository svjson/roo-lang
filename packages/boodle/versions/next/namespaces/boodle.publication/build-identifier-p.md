---
layout: reference
title: boodle.publication/build-identifier?
---
...
<li><a class="active" href="build-identifier-p.html">build-identifier?</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">build-identifier?</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.publication/build-identifier-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.publication.html">boodle.publication</a>/</div>
<h1><code>build-identifier?</code></h1>
</header>
