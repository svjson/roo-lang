...
<option value="../../../{{ publication.identity }}/namespaces/boodle.cli/version.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
