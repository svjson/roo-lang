---
layout: reference
title: boodle.format.lookup/lookup-namespace
---
...
<li><a class="active" href="lookup-namespace.html">lookup-namespace</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">lookup-namespace</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.lookup/lookup-namespace.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.lookup.html">boodle.format.lookup</a>/</div>
<h1><code>lookup-namespace</code></h1>
</header>
