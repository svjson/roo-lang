---
layout: reference
title: boodle.format.lookup/append-name
---
...
<ol>
<li><a class="active" href="append-name.html">append-name</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">append-name</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.lookup/append-name.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.lookup.html">boodle.format.lookup</a>/</div>
<h1><code>append-name</code></h1>
</header>
