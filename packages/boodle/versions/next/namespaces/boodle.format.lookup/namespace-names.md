---
layout: reference
title: boodle.format.lookup/namespace-names
---
...
<li><a class="active" href="namespace-names.html">namespace-names</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">namespace-names</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.lookup/namespace-names.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.lookup.html">boodle.format.lookup</a>/</div>
<h1><code>namespace-names</code></h1>
</header>
