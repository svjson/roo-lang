---
layout: reference
title: boodle.format.lookup/entries-in-namespace
---
...
<li><a class="active" href="entries-in-namespace.html">entries-in-namespace</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">entries-in-namespace</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.lookup/entries-in-namespace.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.format.lookup.html">boodle.format.lookup</a>/</div>
<h1><code>entries-in-namespace</code></h1>
</header>
...
```roo
(entries-in-namespace index name)
```
