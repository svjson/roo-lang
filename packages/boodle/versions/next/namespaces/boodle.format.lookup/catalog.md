---
layout: reference
title: boodle.format.lookup/catalog
---
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.format.lookup/catalog.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
