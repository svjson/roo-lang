---
layout: reference
title: boodle.command.generate/read-catalog
---
...
<li><a class="active" href="read-catalog.html">read-catalog</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">read-catalog</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.command.generate/read-catalog.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.command.generate.html">boodle.command.generate</a>/</div>
<h1><code>read-catalog</code></h1>
</header>
