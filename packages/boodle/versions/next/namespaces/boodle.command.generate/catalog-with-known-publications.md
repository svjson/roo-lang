---
layout: reference
title: boodle.command.generate/catalog-with-known-publications
---
...
<li><a class="active" href="catalog-with-known-publications.html">catalog-with-known-publications</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">catalog-with-known-publications</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.command.generate/catalog-with-known-publications.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.command.generate.html">boodle.command.generate</a>/</div>
<h1><code>catalog-with-known-publications</code></h1>
</header>
...
```roo
(catalog-with-known-publications output-dir catalog)
```
