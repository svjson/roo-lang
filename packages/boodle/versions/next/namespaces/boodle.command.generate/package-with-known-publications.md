---
layout: reference
title: boodle.command.generate/package-with-known-publications
---
...
<li><a class="active" href="package-with-known-publications.html">package-with-known-publications</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">package-with-known-publications</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.command.generate/package-with-known-publications.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.command.generate.html">boodle.command.generate</a>/</div>
<h1><code>package-with-known-publications</code></h1>
</header>
