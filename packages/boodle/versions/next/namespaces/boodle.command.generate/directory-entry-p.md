---
layout: reference
title: boodle.command.generate/directory-entry?
---
...
<li><a class="active" href="directory-entry-p.html">directory-entry?</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">directory-entry?</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.command.generate/directory-entry-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.command.generate.html">boodle.command.generate</a>/</div>
<h1><code>directory-entry?</code></h1>
</header>
