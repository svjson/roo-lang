---
layout: reference
title: boodle.command.generate/append-package-id-once
---
...
<ol>
<li><a class="active" href="append-package-id-once.html">append-package-id-once</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">append-package-id-once</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.command.generate/append-package-id-once.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.command.generate.html">boodle.command.generate</a>/</div>
<h1><code>append-package-id-once</code></h1>
</header>
