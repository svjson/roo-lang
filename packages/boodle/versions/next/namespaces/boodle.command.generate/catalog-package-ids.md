---
layout: reference
title: boodle.command.generate/catalog-package-ids
---
...
<li><a class="active" href="catalog-package-ids.html">catalog-package-ids</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">catalog-package-ids</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.command.generate/catalog-package-ids.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.command.generate.html">boodle.command.generate</a>/</div>
<h1><code>catalog-package-ids</code></h1>
</header>
