---
layout: reference
title: boodle.command.generate/apply-retention!
---
...
<li><a class="active" href="apply-retention-bang.html">apply-retention!</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">apply-retention!</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.command.generate/apply-retention-bang.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.command.generate.html">boodle.command.generate</a>/</div>
<h1><code>apply-retention!</code></h1>
</header>
...
```roo
(apply-retention! output-dir catalog publication)
```
