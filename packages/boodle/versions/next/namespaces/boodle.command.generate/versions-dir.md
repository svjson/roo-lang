---
layout: reference
title: boodle.command.generate/versions-dir
---
...
<li><a class="active" href="versions-dir.html">versions-dir</a></li>
</ol>
</nav>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">versions-dir</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.command.generate/versions-dir.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.command.generate.html">boodle.command.generate</a>/</div>
<h1><code>versions-dir</code></h1>
</header>
...
```roo
(versions-dir output-dir package)
```
