---
layout: reference
title: boodle.command.generate/explicit-package-group-ids
---
...
<li><a class="active" href="explicit-package-group-ids.html">explicit-package-group-ids</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">explicit-package-group-ids</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.command.generate/explicit-package-group-ids.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.command.generate.html">boodle.command.generate</a>/</div>
<h1><code>explicit-package-group-ids</code></h1>
</header>
...
```roo
(explicit-package-group-ids groups)
```
