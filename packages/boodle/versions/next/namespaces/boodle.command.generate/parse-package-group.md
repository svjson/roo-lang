---
layout: reference
title: boodle.command.generate/parse-package-group
---
...
<li><a class="active" href="parse-package-group.html">parse-package-group</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">parse-package-group</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.command.generate/parse-package-group.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.command.generate.html">boodle.command.generate</a>/</div>
<h1><code>parse-package-group</code></h1>
</header>
