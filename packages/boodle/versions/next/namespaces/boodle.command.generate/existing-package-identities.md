---
layout: reference
title: boodle.command.generate/existing-package-identities
---
...
<li><a class="active" href="existing-package-identities.html">existing-package-identities</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">existing-package-identities</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.command.generate/existing-package-identities.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.command.generate.html">boodle.command.generate</a>/</div>
<h1><code>existing-package-identities</code></h1>
</header>
