---
layout: reference
title: boodle.command.generate/command
---
...
<li><a class="active" href="command.html">command</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">command</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.command.generate/command.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
