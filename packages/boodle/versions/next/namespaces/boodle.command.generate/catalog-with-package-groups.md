---
layout: reference
title: boodle.command.generate/catalog-with-package-groups
---
...
<li><a class="active" href="catalog-with-package-groups.html">catalog-with-package-groups</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">catalog-with-package-groups</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.command.generate/catalog-with-package-groups.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.command.generate.html">boodle.command.generate</a>/</div>
<h1><code>catalog-with-package-groups</code></h1>
</header>
...
```roo
(catalog-with-package-groups catalog groups)
```
