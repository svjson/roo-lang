---
layout: reference
title: boodle.command.generate/catalog-with-navigation-style
---
...
<li><a class="active" href="catalog-with-navigation-style.html">catalog-with-navigation-style</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">catalog-with-navigation-style</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/boodle.command.generate/catalog-with-navigation-style.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../boodle.command.generate.html">boodle.command.generate</a>/</div>
<h1><code>catalog-with-navigation-style</code></h1>
</header>
...
```roo
(catalog-with-navigation-style catalog style)
```
