...
<li><a class="active" href="flag-p.html">flag?</a></li>
</ol>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/cli-trooper.parse.flag/flag-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
