---
layout: reference
title: proofread.inspect.bindings/body-use-count
---
...
<li><a class="active" href="body-use-count.html">body-use-count</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">body-use-count</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.inspect.bindings/body-use-count.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.inspect.bindings.html">proofread.inspect.bindings</a>/</div>
<h1><code>body-use-count</code></h1>
</header>
