---
layout: reference
title: proofread.inspect.bindings/let-bindings
---
...
<li><a class="active" href="let-bindings.html">let-bindings</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">let-bindings</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.inspect.bindings/let-bindings.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.inspect.bindings.html">proofread.inspect.bindings</a>/</div>
<h1><code>let-bindings</code></h1>
</header>
...
```roo
(let-bindings {:keys [children] :as node})
```
