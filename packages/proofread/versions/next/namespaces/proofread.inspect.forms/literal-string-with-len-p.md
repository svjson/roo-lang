---
layout: reference
title: proofread.inspect.forms/literal-string-with-len?
---
...
<li><a class="active" href="literal-string-with-len-p.html">literal-string-with-len?</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">literal-string-with-len?</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.inspect.forms/literal-string-with-len-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.inspect.forms.html">proofread.inspect.forms</a>/</div>
<h1><code>literal-string-with-len?</code></h1>
</header>
...
```roo
(literal-string-with-len? node length)
```
