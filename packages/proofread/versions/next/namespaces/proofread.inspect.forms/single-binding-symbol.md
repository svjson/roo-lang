---
layout: reference
title: proofread.inspect.forms/single-binding-symbol
---
...
<li><a class="active" href="single-binding-symbol.html">single-binding-symbol</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">single-binding-symbol</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.inspect.forms/single-binding-symbol.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.inspect.forms.html">proofread.inspect.forms</a>/</div>
<h1><code>single-binding-symbol</code></h1>
</header>
...
```roo
(single-binding-symbol {:keys [children] :as node})
```
