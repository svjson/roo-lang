---
layout: reference
title: proofread.inspect.forms/cond-test-child?
---
...
<li><a class="active" href="cond-test-child-p.html">cond-test-child?</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">cond-test-child?</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.inspect.forms/cond-test-child-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.inspect.forms.html">proofread.inspect.forms</a>/</div>
<h1><code>cond-test-child?</code></h1>
</header>
...
```roo
(cond-test-child? {:keys [children] :as parent} node)
```
