---
layout: reference
title: proofread.inspect.forms/thread-first-transform?
---
...
<li><a class="active" href="thread-first-transform-p.html">thread-first-transform?</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">thread-first-transform?</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.inspect.forms/thread-first-transform-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.inspect.forms.html">proofread.inspect.forms</a>/</div>
<h1><code>thread-first-transform?</code></h1>
</header>
...
```roo
(thread-first-transform? {:keys [children] :as node} value)
```
