---
layout: reference
title: proofread.inspect.forms/keyword-lookup-key-name
---
...
<li><a class="active" href="keyword-lookup-key-name.html">keyword-lookup-key-name</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">keyword-lookup-key-name</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.inspect.forms/keyword-lookup-key-name.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.inspect.forms.html">proofread.inspect.forms</a>/</div>
<h1><code>keyword-lookup-key-name</code></h1>
</header>
...
```roo
(keyword-lookup-key-name {:keys [children] :as node})
```
