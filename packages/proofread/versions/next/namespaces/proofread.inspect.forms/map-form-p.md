---
layout: reference
title: proofread.inspect.forms/map-form?
---
...
<li><a class="active" href="map-form-p.html">map-form?</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">map-form?</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.inspect.forms/map-form-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.inspect.forms.html">proofread.inspect.forms</a>/</div>
<h1><code>map-form?</code></h1>
</header>
...
```roo
(map-form? {:keys [children] :as node})
```
