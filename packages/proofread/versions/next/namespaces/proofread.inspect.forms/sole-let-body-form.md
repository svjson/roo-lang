---
layout: reference
title: proofread.inspect.forms/sole-let-body-form
---
...
<li><a class="active" href="sole-let-body-form.html">sole-let-body-form</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">sole-let-body-form</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.inspect.forms/sole-let-body-form.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.inspect.forms.html">proofread.inspect.forms</a>/</div>
<h1><code>sole-let-body-form</code></h1>
</header>
...
```roo
(sole-let-body-form {:keys [children] :as node})
```
