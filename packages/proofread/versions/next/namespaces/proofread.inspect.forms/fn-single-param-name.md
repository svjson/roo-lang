---
layout: reference
title: proofread.inspect.forms/fn-single-param-name
---
...
<li><a class="active" href="fn-single-param-name.html">fn-single-param-name</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">fn-single-param-name</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.inspect.forms/fn-single-param-name.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.inspect.forms.html">proofread.inspect.forms</a>/</div>
<h1><code>fn-single-param-name</code></h1>
</header>
...
```roo
(fn-single-param-name {:keys [children] :as node})
```
