---
layout: reference
title: proofread.inspect.forms/form-sequence-string
---
...
<li><a class="active" href="form-sequence-string.html">form-sequence-string</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">form-sequence-string</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.inspect.forms/form-sequence-string.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.inspect.forms.html">proofread.inspect.forms</a>/</div>
<h1><code>form-sequence-string</code></h1>
</header>
...
The node forms joined by spaces, or `nil` when `nodes` is empty.
