---
layout: reference
title: proofread.inspect.forms/keyword-lookup?
---
...
<li><a class="active" href="keyword-lookup-p.html">keyword-lookup?</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">keyword-lookup?</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.inspect.forms/keyword-lookup-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.inspect.forms.html">proofread.inspect.forms</a>/</div>
<h1><code>keyword-lookup?</code></h1>
</header>
...
```roo
(keyword-lookup? node target-name)
```
