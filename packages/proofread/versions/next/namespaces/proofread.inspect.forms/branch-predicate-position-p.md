---
layout: reference
title: proofread.inspect.forms/branch-predicate-position?
---
...
<ol>
<li><a class="active" href="branch-predicate-position-p.html">branch-predicate-position?</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">branch-predicate-position?</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.inspect.forms/branch-predicate-position-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.inspect.forms.html">proofread.inspect.forms</a>/</div>
<h1><code>branch-predicate-position?</code></h1>
</header>
...
```roo
(branch-predicate-position? {:keys [children] :as parent} node)
```
