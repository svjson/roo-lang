---
layout: reference
title: proofread.inspect.forms/count-argument
---
...
<li><a class="active" href="count-argument.html">count-argument</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">count-argument</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.inspect.forms/count-argument.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.inspect.forms.html">proofread.inspect.forms</a>/</div>
<h1><code>count-argument</code></h1>
</header>
...
```roo
(count-argument {:keys [children] :as node})
```
