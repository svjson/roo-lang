---
layout: reference
title: proofread.command.check/diagnostic-count
---
...
<li><a class="active" href="diagnostic-count.html">diagnostic-count</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">diagnostic-count</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.command.check/diagnostic-count.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.command.check.html">proofread.command.check</a>/</div>
<h1><code>diagnostic-count</code></h1>
</header>
...
```roo
(diagnostic-count diagnostics severity)
```
