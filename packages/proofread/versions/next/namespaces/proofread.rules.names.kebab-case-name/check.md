---
layout: reference
title: proofread.rules.names.kebab-case-name/check
---
...
<li><a href="non-kebab-name-p.html">non-kebab-name?</a></li>
</ol>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.rules.names.kebab-case-name/check.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
