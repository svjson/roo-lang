---
layout: reference
title: proofread.rules.simple-expressions.use-clamp/check
---
...
<li><a href="nested-clamp-call-p.html">nested-clamp-call?</a></li>
</ol>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.rules.simple-expressions.use-clamp/check.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
