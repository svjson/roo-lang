---
layout: reference
title: proofread.rules.redundant-functions.redundant-function/directly-redundant-predicate-call?
---
...
<li><a class="active" href="directly-redundant-predicate-call-p.html">directly-redundant-predicate-call?</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">directly-redundant-predicate-call?</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.rules.redundant-functions.redundant-function/directly-redundant-predicate-call-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
...
<h1><code>directly-redundant-predicate-call?</code></h1>
</header>
...
```roo
(directly-redundant-predicate-call? node)
```
