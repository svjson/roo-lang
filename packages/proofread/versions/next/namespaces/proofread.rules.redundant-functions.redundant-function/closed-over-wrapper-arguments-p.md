---
layout: reference
title: proofread.rules.redundant-functions.redundant-function/closed-over-wrapper-arguments?
---
...
<li><a class="active" href="closed-over-wrapper-arguments-p.html">closed-over-wrapper-arguments?</a></li>
...
<li><a href="skipped-function-p.html">skipped-function?</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">closed-over-wrapper-arguments?</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.rules.redundant-functions.redundant-function/closed-over-wrapper-arguments-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
...
<h1><code>closed-over-wrapper-arguments?</code></h1>
</header>
...
```roo
(closed-over-wrapper-arguments? children index param-names closed-over?)
```
