---
layout: reference
title: proofread.rules.redundant-functions.redundant-function/literal-node?
---
...
<li><a class="active" href="literal-node-p.html">literal-node?</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">literal-node?</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.rules.redundant-functions.redundant-function/literal-node-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
