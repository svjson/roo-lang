---
layout: reference
title: proofread.rules.simple-expressions.use-type-predicate/predicates
---
...
<li><a class="active" href="predicates.html">predicates</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">predicates</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.rules.simple-expressions.use-type-predicate/predicates.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
