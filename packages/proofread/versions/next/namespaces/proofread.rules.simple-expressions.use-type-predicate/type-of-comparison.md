---
layout: reference
title: proofread.rules.simple-expressions.use-type-predicate/type-of-comparison
---
...
<li><a class="active" href="type-of-comparison.html">type-of-comparison</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">type-of-comparison</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.rules.simple-expressions.use-type-predicate/type-of-comparison.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
...
<h1><code>type-of-comparison</code></h1>
</header>
...
```roo
(type-of-comparison {:keys [children] :as node})
```
