---
layout: reference
title: proofread.rules.simple-expressions.use-type-predicate/type-predicate
---
...
<li><a class="active" href="type-predicate.html">type-predicate</a></li>
</ol>
</nav>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">type-predicate</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.rules.simple-expressions.use-type-predicate/type-predicate.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
...
<h1><code>type-predicate</code></h1>
</header>
