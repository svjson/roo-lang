---
layout: reference
title: proofread.source.walk/directory-files
---
...
<li><a class="active" href="directory-files.html">directory-files</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">directory-files</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.source.walk/directory-files.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.source.walk.html">proofread.source.walk</a>/</div>
<h1><code>directory-files</code></h1>
</header>
