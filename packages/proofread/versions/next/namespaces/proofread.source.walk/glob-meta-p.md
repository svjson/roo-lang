---
layout: reference
title: proofread.source.walk/glob-meta?
---
...
<li><a class="active" href="glob-meta-p.html">glob-meta?</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">glob-meta?</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.source.walk/glob-meta-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.source.walk.html">proofread.source.walk</a>/</div>
<h1><code>glob-meta?</code></h1>
</header>
