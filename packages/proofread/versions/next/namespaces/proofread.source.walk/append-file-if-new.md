---
layout: reference
title: proofread.source.walk/append-file-if-new
---
...
<ol>
<li><a class="active" href="append-file-if-new.html">append-file-if-new</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">append-file-if-new</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.source.walk/append-file-if-new.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.source.walk.html">proofread.source.walk</a>/</div>
<h1><code>append-file-if-new</code></h1>
</header>

<hr class="signature-divider">

```roo
(append-file-if-new files path)
```
