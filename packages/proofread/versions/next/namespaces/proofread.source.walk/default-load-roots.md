---
layout: reference
title: proofread.source.walk/default-load-roots
---
...
<li><a class="active" href="default-load-roots.html">default-load-roots</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">default-load-roots</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.source.walk/default-load-roots.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.source.walk.html">proofread.source.walk</a>/</div>
<h1><code>default-load-roots</code></h1>
</header>
