---
layout: reference
title: proofread.source.walk/source-walk-descend?
---
...
<li><a class="active" href="source-walk-descend-p.html">source-walk-descend?</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">source-walk-descend?</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.source.walk/source-walk-descend-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.source.walk.html">proofread.source.walk</a>/</div>
<h1><code>source-walk-descend?</code></h1>
</header>

<hr class="signature-divider">

```roo
(source-walk-descend? entry metadata)
```
