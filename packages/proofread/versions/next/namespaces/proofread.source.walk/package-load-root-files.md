---
layout: reference
title: proofread.source.walk/package-load-root-files
---
...
<li><a class="active" href="package-load-root-files.html">package-load-root-files</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">package-load-root-files</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.source.walk/package-load-root-files.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.source.walk.html">proofread.source.walk</a>/</div>
<h1><code>package-load-root-files</code></h1>
</header>

<hr class="signature-divider">

```roo
(package-load-root-files root package-root)
```
