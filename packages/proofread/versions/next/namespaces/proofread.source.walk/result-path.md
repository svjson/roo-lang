---
layout: reference
title: proofread.source.walk/result-path
---
...
<li><a class="active" href="result-path.html">result-path</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">result-path</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.source.walk/result-path.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.source.walk.html">proofread.source.walk</a>/</div>
<h1><code>result-path</code></h1>
</header>
