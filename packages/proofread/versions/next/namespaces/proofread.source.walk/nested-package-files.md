---
layout: reference
title: proofread.source.walk/nested-package-files
---
...
<li><a class="active" href="nested-package-files.html">nested-package-files</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">nested-package-files</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.source.walk/nested-package-files.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.source.walk.html">proofread.source.walk</a>/</div>
<h1><code>nested-package-files</code></h1>
</header>

<hr class="signature-divider">

```roo
(nested-package-files root excluded-root)
```
