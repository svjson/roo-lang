---
layout: reference
title: proofread.source.walk/collect-pattern
---
...
<li><a class="active" href="collect-pattern.html">collect-pattern</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">collect-pattern</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.source.walk/collect-pattern.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.source.walk.html">proofread.source.walk</a>/</div>
<h1><code>collect-pattern</code></h1>
</header>

<hr class="signature-divider">

```roo
(collect-pattern result pattern)
```
