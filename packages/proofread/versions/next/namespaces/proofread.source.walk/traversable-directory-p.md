---
layout: reference
title: proofread.source.walk/traversable-directory?
---
...
<li><a class="active" href="traversable-directory-p.html">traversable-directory?</a></li>
</ol>
</nav>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">traversable-directory?</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.source.walk/traversable-directory-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.source.walk.html">proofread.source.walk</a>/</div>
<h1><code>traversable-directory?</code></h1>
</header>

<hr class="signature-divider">

```roo
(traversable-directory? entry metadata)
```
