---
layout: reference
title: proofread.source.walk/package-root?
---
...
<li><a class="active" href="package-root-p.html">package-root?</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">package-root?</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.source.walk/package-root-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.source.walk.html">proofread.source.walk</a>/</div>
<h1><code>package-root?</code></h1>
</header>
