---
layout: reference
title: proofread.source.walk/package-roots-under
---
...
<li><a class="active" href="package-roots-under.html">package-roots-under</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">package-roots-under</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.source.walk/package-roots-under.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.source.walk.html">proofread.source.walk</a>/</div>
<h1><code>package-roots-under</code></h1>
</header>
