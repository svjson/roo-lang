---
layout: reference
title: proofread.source.walk/source-files-under
---
...
<li><a class="active" href="source-files-under.html">source-files-under</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">source-files-under</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.source.walk/source-files-under.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.source.walk.html">proofread.source.walk</a>/</div>
<h1><code>source-files-under</code></h1>
</header>
