---
layout: reference
title: proofread.source.walk/append-files
---
...
<li><a class="active" href="append-files.html">append-files</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">append-files</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.source.walk/append-files.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.source.walk.html">proofread.source.walk</a>/</div>
<h1><code>append-files</code></h1>
</header>

<hr class="signature-divider">

```roo
(append-files files paths)
```
