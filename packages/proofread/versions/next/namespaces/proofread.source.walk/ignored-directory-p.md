---
layout: reference
title: proofread.source.walk/ignored-directory?
---
...
<li><a class="active" href="ignored-directory-p.html">ignored-directory?</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">ignored-directory?</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.source.walk/ignored-directory-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.source.walk.html">proofread.source.walk</a>/</div>
<h1><code>ignored-directory?</code></h1>
</header>
...
```roo
(ignored-directory? {:keys [name] :as entry} metadata)
```
