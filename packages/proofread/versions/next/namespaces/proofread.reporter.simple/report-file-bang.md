---
layout: reference
title: proofread.reporter.simple/report-file!
---
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.reporter.simple/report-file-bang.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
...
Print diagnostics for one checked file.
