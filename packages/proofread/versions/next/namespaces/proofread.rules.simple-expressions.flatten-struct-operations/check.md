---
layout: reference
title: proofread.rules.simple-expressions.flatten-struct-operations/check
---
...
<li><a href="operation-chain.html">operation-chain</a></li>
</ol>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.rules.simple-expressions.flatten-struct-operations/check.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
