---
layout: reference
title: proofread.rules.registry/known-rule?
---
...
<li><a class="active" href="known-rule-p.html">known-rule?</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">known-rule?</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.rules.registry/known-rule-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.rules.registry.html">proofread.rules.registry</a>/</div>
<h1><code>known-rule?</code></h1>
</header>
