---
layout: reference
title: proofread.rules.diagnostics/make-file
---
...
<li><a class="active" href="make-file.html">make-file</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">make-file</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.rules.diagnostics/make-file.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.rules.diagnostics.html">proofread.rules.diagnostics</a>/</div>
<h1><code>make-file</code></h1>
</header>
