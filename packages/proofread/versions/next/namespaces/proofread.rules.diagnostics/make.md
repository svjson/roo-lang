---
layout: reference
title: proofread.rules.diagnostics/make
---
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.rules.diagnostics/make.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
