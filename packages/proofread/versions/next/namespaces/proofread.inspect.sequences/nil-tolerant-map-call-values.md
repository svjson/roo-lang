---
layout: reference
title: proofread.inspect.sequences/nil-tolerant-map-call-values
---
...
<li><a class="active" href="nil-tolerant-map-call-values.html">nil-tolerant-map-call-values</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">nil-tolerant-map-call-values</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.inspect.sequences/nil-tolerant-map-call-values.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.inspect.sequences.html">proofread.inspect.sequences</a>/</div>
<h1><code>nil-tolerant-map-call-values</code></h1>
</header>
...
```roo
(nil-tolerant-map-call-values node)
```
