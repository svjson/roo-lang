---
layout: reference
title: proofread.inspect.sequences/nil-tolerant-seq-binding-rules
---
...
<li><a class="active" href="nil-tolerant-seq-binding-rules.html">nil-tolerant-seq-binding-rules</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">nil-tolerant-seq-binding-rules</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.inspect.sequences/nil-tolerant-seq-binding-rules.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.inspect.sequences.html">proofread.inspect.sequences</a>/</div>
<h1><code>nil-tolerant-seq-binding-rules</code></h1>
</header>
