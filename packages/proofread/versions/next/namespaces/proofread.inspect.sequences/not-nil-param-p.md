---
layout: reference
title: proofread.inspect.sequences/not-nil-param?
---
...
<li><a class="active" href="not-nil-param-p.html">not-nil-param?</a></li>
</ol>
</nav>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">not-nil-param?</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.inspect.sequences/not-nil-param-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.inspect.sequences.html">proofread.inspect.sequences</a>/</div>
<h1><code>not-nil-param?</code></h1>
</header>
...
```roo
(not-nil-param? {:keys [children] :as node} param-name)
```
