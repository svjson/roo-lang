---
layout: reference
title: proofread.rules.higher-order.use-flat-map/candidate?
---
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.rules.higher-order.use-flat-map/candidate-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
