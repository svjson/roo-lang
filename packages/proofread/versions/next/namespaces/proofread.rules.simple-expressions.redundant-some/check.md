---
layout: reference
title: proofread.rules.simple-expressions.redundant-some/check
---
...
<li><a href="non-predicate-name-p.html">non-predicate-name?</a></li>
</ol>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.rules.simple-expressions.redundant-some/check.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
