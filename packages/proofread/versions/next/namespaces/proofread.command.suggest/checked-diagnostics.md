---
layout: reference
title: proofread.command.suggest/checked-diagnostics
---
...
<ol>
<li><a class="active" href="checked-diagnostics.html">checked-diagnostics</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">checked-diagnostics</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.command.suggest/checked-diagnostics.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.command.suggest.html">proofread.command.suggest</a>/</div>
<h1><code>checked-diagnostics</code></h1>
</header>

<hr class="signature-divider">

```roo
(checked-diagnostics file)
```
