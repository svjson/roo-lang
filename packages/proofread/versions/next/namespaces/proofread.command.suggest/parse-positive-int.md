---
layout: reference
title: proofread.command.suggest/parse-positive-int
---
...
<li><a class="active" href="parse-positive-int.html">parse-positive-int</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">parse-positive-int</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.command.suggest/parse-positive-int.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.command.suggest.html">proofread.command.suggest</a>/</div>
<h1><code>parse-positive-int</code></h1>
</header>
