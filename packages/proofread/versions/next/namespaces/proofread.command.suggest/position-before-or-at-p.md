---
layout: reference
title: proofread.command.suggest/position-before-or-at?
---
...
<li><a class="active" href="position-before-or-at-p.html">position-before-or-at?</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">position-before-or-at?</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.command.suggest/position-before-or-at-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.command.suggest.html">proofread.command.suggest</a>/</div>
<h1><code>position-before-or-at?</code></h1>
</header>

<hr class="signature-divider">

```roo
(position-before-or-at? left right)
```
