---
layout: reference
title: proofread.command.suggest/suggestions-at
---
...
<li><a class="active" href="suggestions-at.html">suggestions-at</a></li>
</ol>
</nav>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">suggestions-at</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.command.suggest/suggestions-at.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.command.suggest.html">proofread.command.suggest</a>/</div>
<h1><code>suggestions-at</code></h1>
</header>
...
```roo
(suggestions-at diagnostics line column)
```
