---
layout: reference
title: proofread.command.suggest/position-before?
---
...
<li><a class="active" href="position-before-p.html">position-before?</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">position-before?</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.command.suggest/position-before-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.command.suggest.html">proofread.command.suggest</a>/</div>
<h1><code>position-before?</code></h1>
</header>
