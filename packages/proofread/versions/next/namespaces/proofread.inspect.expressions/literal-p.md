---
layout: reference
title: proofread.inspect.expressions/literal?
---
...
<li><a class="active" href="literal-p.html">literal?</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">literal?</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.inspect.expressions/literal-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.inspect.expressions.html">proofread.inspect.expressions</a>/</div>
<h1><code>literal?</code></h1>
</header>
