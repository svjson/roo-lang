---
layout: reference
title: proofread.inspect.expressions/default-simple-call-heads
---
...
<li><a class="active" href="default-simple-call-heads.html">default-simple-call-heads</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">default-simple-call-heads</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.inspect.expressions/default-simple-call-heads.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.inspect.expressions.html">proofread.inspect.expressions</a>/</div>
<h1><code>default-simple-call-heads</code></h1>
</header>
