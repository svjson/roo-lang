---
layout: reference
title: proofread.inspect.expressions/simple-call?
---
...
<li><a class="active" href="simple-call-p.html">simple-call?</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">simple-call?</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.inspect.expressions/simple-call-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.inspect.expressions.html">proofread.inspect.expressions</a>/</div>
<h1><code>simple-call?</code></h1>
</header>
...
```roo
(simple-call? {:keys [children] :as node} options)
```
