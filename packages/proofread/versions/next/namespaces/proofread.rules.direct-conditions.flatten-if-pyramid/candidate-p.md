---
layout: reference
title: proofread.rules.direct-conditions.flatten-if-pyramid/candidate?
---
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.rules.direct-conditions.flatten-if-pyramid/candidate-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
