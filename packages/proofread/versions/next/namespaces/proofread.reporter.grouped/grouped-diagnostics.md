---
layout: reference
title: proofread.reporter.grouped/grouped-diagnostics
---
...
<li><a class="active" href="grouped-diagnostics.html">grouped-diagnostics</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">grouped-diagnostics</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.reporter.grouped/grouped-diagnostics.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.reporter.grouped.html">proofread.reporter.grouped</a>/</div>
<h1><code>grouped-diagnostics</code></h1>
</header>
...
```roo
(grouped-diagnostics diagnostics criterion value)
```
