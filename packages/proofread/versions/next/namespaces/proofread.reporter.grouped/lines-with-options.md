---
layout: reference
title: proofread.reporter.grouped/lines-with-options
---
...
<li><a class="active" href="lines-with-options.html">lines-with-options</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">lines-with-options</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.reporter.grouped/lines-with-options.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.reporter.grouped.html">proofread.reporter.grouped</a>/</div>
<h1><code>lines-with-options</code></h1>
</header>

Return grouped reporter diagnostic lines with display options.

<hr class="signature-divider">

```roo
(lines-with-options diagnostics groups options)
```
