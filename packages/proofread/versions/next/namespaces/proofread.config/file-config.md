---
layout: reference
title: proofread.config/file-config
---
...
<li><a class="active" href="file-config.html">file-config</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">file-config</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.config/file-config.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.config.html">proofread.config</a>/</div>
<h1><code>file-config</code></h1>
</header>
