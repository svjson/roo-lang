---
layout: reference
title: proofread.config/diagnostic-severity
---
...
<li><a class="active" href="diagnostic-severity.html">diagnostic-severity</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">diagnostic-severity</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.config/diagnostic-severity.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.config.html">proofread.config</a>/</div>
<h1><code>diagnostic-severity</code></h1>
</header>
...
```roo
(diagnostic-severity config diagnostic)
```
