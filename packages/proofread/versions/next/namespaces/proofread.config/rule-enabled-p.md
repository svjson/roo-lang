---
layout: reference
title: proofread.config/rule-enabled?
---
...
<li><a class="active" href="rule-enabled-p.html">rule-enabled?</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">rule-enabled?</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.config/rule-enabled-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.config.html">proofread.config</a>/</div>
<h1><code>rule-enabled?</code></h1>
</header>
