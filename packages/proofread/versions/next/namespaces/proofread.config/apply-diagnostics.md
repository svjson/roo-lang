---
layout: reference
title: proofread.config/apply-diagnostics
---
...
<li><a class="active" href="apply-diagnostics.html">apply-diagnostics</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">apply-diagnostics</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.config/apply-diagnostics.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.config.html">proofread.config</a>/</div>
<h1><code>apply-diagnostics</code></h1>
</header>
...
```roo
(apply-diagnostics config diagnostics)
```
