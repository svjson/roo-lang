---
layout: reference
title: proofread.config/config-file
---
...
<li><a class="active" href="config-file.html">config-file</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">config-file</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/proofread.config/config-file.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../proofread.config.html">proofread.config</a>/</div>
<h1><code>config-file</code></h1>
</header>
