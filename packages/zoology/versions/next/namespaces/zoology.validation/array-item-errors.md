---
layout: reference
title: zoology.validation/array-item-errors
---
...
<li><a class="active" href="array-item-errors.html">array-item-errors</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">array-item-errors</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/zoology.validation/array-item-errors.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../zoology.validation.html">zoology.validation</a>/</div>
<h1><code>array-item-errors</code></h1>
</header>

<hr class="signature-divider">

```roo
(array-item-errors schema context value field-schema)
```
