---
layout: reference
title: zoology.validation/max-error
---
...
<li><a class="active" href="max-error.html">max-error</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">max-error</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/zoology.validation/max-error.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../zoology.validation.html">zoology.validation</a>/</div>
<h1><code>max-error</code></h1>
</header>

<hr class="signature-divider">

```roo
(max-error value {:keys [max]})
```
