---
layout: reference
title: zoology.validation/array-value-error
---
...
<li><a class="active" href="array-value-error.html">array-value-error</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">array-value-error</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/zoology.validation/array-value-error.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../zoology.validation.html">zoology.validation</a>/</div>
<h1><code>array-value-error</code></h1>
</header>

<hr class="signature-divider">

```roo
(array-value-error schema context value field-schema)
```
