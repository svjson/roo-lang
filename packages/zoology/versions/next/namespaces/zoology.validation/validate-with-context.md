---
layout: reference
title: zoology.validation/validate-with-context
---
...
<li><a class="active" href="validate-with-context.html">validate-with-context</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">validate-with-context</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/zoology.validation/validate-with-context.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../zoology.validation.html">zoology.validation</a>/</div>
<h1><code>validate-with-context</code></h1>
</header>

<hr class="signature-divider">

```roo
(validate-with-context schema value context)
```
