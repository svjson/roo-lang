---
layout: reference
title: zoology.validation/append-error
---
...
<ol>
<li><a class="active" href="append-error.html">append-error</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">append-error</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/zoology.validation/append-error.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../zoology.validation.html">zoology.validation</a>/</div>
<h1><code>append-error</code></h1>
</header>
