---
layout: reference
title: zoology.validation/required-error
---
...
<li><a class="active" href="required-error.html">required-error</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">required-error</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/zoology.validation/required-error.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../zoology.validation.html">zoology.validation</a>/</div>
<h1><code>required-error</code></h1>
</header>

<hr class="signature-divider">

```roo
(required-error value field-schema)
```
