---
layout: reference
title: zoology.validation/validation-errors-with-context
---
...
<li><a href="valid-value-error.html">valid-value-error</a></li>
...
<li><a class="active" href="validation-errors-with-context.html">validation-errors-with-context</a></li>
</ol>
</nav>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">validation-errors-with-context</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/zoology.validation/validation-errors-with-context.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../zoology.validation.html">zoology.validation</a>/</div>
<h1><code>validation-errors-with-context</code></h1>
</header>

<hr class="signature-divider">

```roo
(validation-errors-with-context schema value context)
```
