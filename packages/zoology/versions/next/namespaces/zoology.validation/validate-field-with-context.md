---
layout: reference
title: zoology.validation/validate-field-with-context
---
...
<li><a class="active" href="validate-field-with-context.html">validate-field-with-context</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">validate-field-with-context</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/zoology.validation/validate-field-with-context.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../zoology.validation.html">zoology.validation</a>/</div>
<h1><code>validate-field-with-context</code></h1>
</header>

<hr class="signature-divider">

```roo
(validate-field-with-context schema value field-id context)
```
