---
layout: reference
title: zoology.validation/validate-field
---
...
<li><a class="active" href="validate-field.html">validate-field</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">validate-field</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/zoology.validation/validate-field.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../zoology.validation.html">zoology.validation</a>/</div>
<h1><code>validate-field</code></h1>
</header>

<hr class="signature-divider">

```roo
(validate-field schema value field-id)
```
