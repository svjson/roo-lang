---
layout: reference
title: zoology.validation/object-field-error
---
...
<li><a class="active" href="object-field-error.html">object-field-error</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">object-field-error</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/zoology.validation/object-field-error.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../zoology.validation.html">zoology.validation</a>/</div>
<h1><code>object-field-error</code></h1>
</header>

<hr class="signature-divider">

```roo
(object-field-error schema context value field-schema)
```
