---
layout: reference
title: zoology.validation/min-error
---
...
<li><a class="active" href="min-error.html">min-error</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">min-error</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/zoology.validation/min-error.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../zoology.validation.html">zoology.validation</a>/</div>
<h1><code>min-error</code></h1>
</header>

<hr class="signature-divider">

```roo
(min-error value {:keys [min]})
```
