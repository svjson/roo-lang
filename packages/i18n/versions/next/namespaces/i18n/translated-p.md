...
<li><a class="active" href="translated-p.html">translated?</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">translated?</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/i18n/translated-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../i18n.html">i18n</a>/</div>
<h1><code>translated?</code></h1>
</header>
