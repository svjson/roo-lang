...
<option value="../../../{{ publication.identity }}/namespaces/i18n/message.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
