...
<li><a class="active" href="locale-messages.html">locale-messages</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">locale-messages</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/i18n/locale-messages.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../i18n.html">i18n</a>/</div>
<h1><code>locale-messages</code></h1>
</header>
...
```roo
(locale-messages catalog locale)
```
