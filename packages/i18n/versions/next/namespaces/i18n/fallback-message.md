...
<li><a class="active" href="fallback-message.html">fallback-message</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">fallback-message</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/i18n/fallback-message.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../i18n.html">i18n</a>/</div>
<h1><code>fallback-message</code></h1>
</header>
