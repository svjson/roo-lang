...
<option value="../../../{{ publication.identity }}/namespaces/roopl.repl/close-bang.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
