...
<option value="../../../{{ publication.identity }}/namespaces/spool.context/snapshot.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
