---
layout: reference
title: wraparoo.syntax/constants
---
...
<li><a class="active" href="constants.html">constants</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">constants</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/wraparoo.syntax/constants.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../wraparoo.syntax.html">wraparoo.syntax</a>/</div>
<h1><code>constants</code></h1>
</header>
