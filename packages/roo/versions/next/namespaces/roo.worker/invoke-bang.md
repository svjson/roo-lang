...
<li><a class="active" href="invoke-bang.html">invoke!</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">invoke!</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/roo.worker/invoke-bang.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../roo.worker.html">roo.worker</a>/</div>
<h1><code>invoke!</code></h1>
<div class="symbol-metadata"><span>Since <code>0.1.0</code></span></div>
</header>

Schedule a callable invocation in a named worker runtime.

<hr class="signature-divider">

```roo
(invoke! identity callable args...)
```
