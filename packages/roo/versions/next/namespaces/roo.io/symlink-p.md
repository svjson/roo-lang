...
<li><a class="active" href="symlink-p.html">symlink?</a></li>
...
<option value="../../../{{ publication.identity }}/namespaces/roo.io/symlink-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
