...
<li><a class="active" href="home-directory-bang.html">home-directory!</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">home-directory!</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/roo.io/home-directory-bang.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../roo.io.html">roo.io</a>/</div>
<h1><code>home-directory!</code></h1>
</header>

Return the current user's home directory according to the active filesystem.
