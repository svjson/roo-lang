...
<li><a class="active" href="basename.html">basename</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">basename</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/roo.io/basename.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../roo.io.html">roo.io</a>/</div>
<h1><code>basename</code></h1>
</header>
