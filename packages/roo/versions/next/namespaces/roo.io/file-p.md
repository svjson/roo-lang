...
<li><a class="active" href="file-p.html">file?</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">file?</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/roo.io/file-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
...
Query whether a path exists and is a regular file.
