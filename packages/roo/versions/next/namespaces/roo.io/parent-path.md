...
<li><a class="active" href="parent-path.html">parent-path</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">parent-path</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/roo.io/parent-path.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../roo.io.html">roo.io</a>/</div>
<h1><code>parent-path</code></h1>
</header>

Return the parent path of a path string.
