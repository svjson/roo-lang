...
<li><a class="active" href="copy-file-bang.html">copy-file!</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">copy-file!</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/roo.io/copy-file-bang.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../roo.io.html">roo.io</a>/</div>
<h1><code>copy-file!</code></h1>
</header>

Copy one file, creating parent directories for the destination.
