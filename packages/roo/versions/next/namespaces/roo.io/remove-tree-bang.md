...
<li><a class="active" href="remove-tree-bang.html">remove-tree!</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">remove-tree!</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/roo.io/remove-tree-bang.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../roo.io.html">roo.io</a>/</div>
<h1><code>remove-tree!</code></h1>
</header>
