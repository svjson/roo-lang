...
<li><a class="active" href="dirname.html">dirname</a></li>
...
<option value="../../../{{ publication.identity }}/namespaces/roo.io/dirname.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../roo.io.html">roo.io</a>/</div>
<h1><code>dirname</code></h1>
</header>
