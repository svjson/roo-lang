---
layout: reference
title: roo.string/replace-first
---
...
<li><a class="active" href="replace-first.html">replace-first</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">replace-first</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/roo.string/replace-first.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../roo.string.html">roo.string</a>/</div>
<h1><code>replace-first</code></h1>
</header>

Replace the first literal substring occurrence in a string.

<hr class="signature-divider">

```roo
(replace-first source match replacement)
```
