---
layout: reference
title: footsteps.work/continue-delegated-work
---
...
<li><a class="active" href="continue-delegated-work.html">continue-delegated-work</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">continue-delegated-work</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/footsteps.work/continue-delegated-work.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../footsteps.work.html">footsteps.work</a>/</div>
<h1><code>continue-delegated-work</code></h1>
</header>

<hr class="signature-divider">

```roo
(continue-delegated-work work step child-work)
```
