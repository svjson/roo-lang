...
<option value="../../../{{ publication.identity }}/namespaces/footsteps.work/make.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
