---
layout: reference
title: footsteps.work/apply-step-result
---
...
<li><a class="active" href="apply-step-result.html">apply-step-result</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">apply-step-result</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/footsteps.work/apply-step-result.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../footsteps.work.html">footsteps.work</a>/</div>
<h1><code>apply-step-result</code></h1>
</header>

<hr class="signature-divider">

```roo
(apply-step-result work step result)
```
