---
layout: reference
title: footsteps.work/apply-delegated-work
---
...
<li><a class="active" href="apply-delegated-work.html">apply-delegated-work</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">apply-delegated-work</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/footsteps.work/apply-delegated-work.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../footsteps.work.html">footsteps.work</a>/</div>
<h1><code>apply-delegated-work</code></h1>
</header>
