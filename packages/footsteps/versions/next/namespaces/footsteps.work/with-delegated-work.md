---
layout: reference
title: footsteps.work/with-delegated-work
---
...
<li><a class="active" href="with-delegated-work.html">with-delegated-work</a></li>
</ol>
</nav>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">with-delegated-work</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/footsteps.work/with-delegated-work.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../footsteps.work.html">footsteps.work</a>/</div>
<h1><code>with-delegated-work</code></h1>
</header>

<hr class="signature-divider">

```roo
(with-delegated-work step child-work)
```
