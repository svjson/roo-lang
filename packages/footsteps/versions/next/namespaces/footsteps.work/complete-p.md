...
<option value="../../../{{ publication.identity }}/namespaces/footsteps.work/complete-p.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
