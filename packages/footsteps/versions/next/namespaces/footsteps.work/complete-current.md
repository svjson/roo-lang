---
layout: reference
title: footsteps.work/complete-current
---
...
<li><a class="active" href="complete-current.html">complete-current</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">complete-current</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/footsteps.work/complete-current.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../footsteps.work.html">footsteps.work</a>/</div>
<h1><code>complete-current</code></h1>
</header>
