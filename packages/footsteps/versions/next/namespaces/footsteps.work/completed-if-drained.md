---
layout: reference
title: footsteps.work/completed-if-drained
---
...
<li><a class="active" href="completed-if-drained.html">completed-if-drained</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">completed-if-drained</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/footsteps.work/completed-if-drained.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../footsteps.work.html">footsteps.work</a>/</div>
<h1><code>completed-if-drained</code></h1>
</header>

<hr class="signature-divider">

```roo
(completed-if-drained work)
```
