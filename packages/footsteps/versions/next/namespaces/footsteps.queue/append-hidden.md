---
layout: reference
title: footsteps.queue/append-hidden
---
...
<li><a class="active" href="append-hidden.html">append-hidden</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">append-hidden</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/footsteps.queue/append-hidden.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../footsteps.queue.html">footsteps.queue</a>/</div>
<h1><code>append-hidden</code></h1>
</header>
