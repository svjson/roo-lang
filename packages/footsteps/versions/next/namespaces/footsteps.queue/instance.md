---
layout: reference
title: footsteps.queue/instance
---
...
<li><a class="active" href="instance.html">instance</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">instance</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/footsteps.queue/instance.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../footsteps.queue.html">footsteps.queue</a>/</div>
<h1><code>instance</code></h1>
</header>

<hr class="signature-divider">

```roo
(instance work entry instance-scope)
```
