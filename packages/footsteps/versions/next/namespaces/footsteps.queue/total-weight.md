---
layout: reference
title: footsteps.queue/total-weight
---
...
<li><a class="active" href="total-weight.html">total-weight</a></li>
</ol>
</nav>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">total-weight</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/footsteps.queue/total-weight.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../footsteps.queue.html">footsteps.queue</a>/</div>
<h1><code>total-weight</code></h1>
</header>

<hr class="signature-divider">

```roo
(total-weight work entries)
```
