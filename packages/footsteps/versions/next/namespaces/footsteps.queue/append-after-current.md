---
layout: reference
title: footsteps.queue/append-after-current
---
...
<li><a class="active" href="append-after-current.html">append-after-current</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">append-after-current</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/footsteps.queue/append-after-current.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../footsteps.queue.html">footsteps.queue</a>/</div>
<h1><code>append-after-current</code></h1>
</header>
