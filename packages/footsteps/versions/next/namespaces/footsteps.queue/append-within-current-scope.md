---
layout: reference
title: footsteps.queue/append-within-current-scope
---
...
<li><a class="active" href="append-within-current-scope.html">append-within-current-scope</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">append-within-current-scope</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/footsteps.queue/append-within-current-scope.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../footsteps.queue.html">footsteps.queue</a>/</div>
<h1><code>append-within-current-scope</code></h1>
</header>
