---
layout: reference
title: footsteps.progress/value
---
...
<option value="../../../{{ publication.identity }}/namespaces/footsteps.progress/value.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
