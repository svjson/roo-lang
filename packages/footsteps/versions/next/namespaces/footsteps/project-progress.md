---
layout: reference
title: footsteps/project-progress
---
...
<li><a class="active" href="project-progress.html">project-progress</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">project-progress</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/footsteps/project-progress.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../footsteps.html">footsteps</a>/</div>
<h1><code>project-progress</code></h1>
</header>
...
- `scope`: Map describing the target scope with `:start`, `:end`, and optional label/id fields.
- `report`: Child progress report or work value to project.
