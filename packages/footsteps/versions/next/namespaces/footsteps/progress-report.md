---
layout: reference
title: footsteps/progress-report
---
...
<li><a class="active" href="progress-report.html">progress-report</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">progress-report</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/footsteps/progress-report.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../footsteps.html">footsteps</a>/</div>
<h1><code>progress-report</code></h1>
</header>
...
- `value`: Existing progress report or work value.
