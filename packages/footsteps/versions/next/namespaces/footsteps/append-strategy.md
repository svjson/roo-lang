---
layout: reference
title: footsteps/append-strategy
---
...
<li><a class="active" href="append-strategy.html">append-strategy</a></li>
...
<span class="breadcrumb-separator" aria-hidden="true">/</span>
<span aria-current="page">append-strategy</span>
</nav>
...
<option value="../../../{{ publication.identity }}/namespaces/footsteps/append-strategy.html"{% if publication.identity == "next" %} selected{% endif %}>{{ publication.identity }}</option>
{% endfor %}
</select></label>
</div>
<header class="symbol-heading">
<div class="symbol-namespace"><a href="../footsteps.html">footsteps</a>/</div>
<h1><code>append-strategy</code></h1>
</header>

Append strategy keywords accepted by work step results.



A step can choose one of these values with `:append-strategy` when it returns
`:append`, or a work spec can set `:default-append-strategy`.
