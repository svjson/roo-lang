...
namespace Roo::Server
{
  ...
  class MessageBuilder
  {
   ...
   public:
     ...
     */
    static Response build_response_with_props(
      const std::string& id,
  ...
  class MessageParser
  {
   ...
   private:
     ...
     * indicating success.
     */
    std::optional<Error> read_begin_block(const std::string& data,
                                          size_t* i,
     ...
     * indicating success.
     */
    std::optional<Error> read_end_block(const std::string& data,
                                        size_t* i,
                                        MessageBuilder* builder);
    /*!
     ...
     * indicating success.
     */
    std::optional<Error> read_property(const std::string& data,
                                       size_t* i,
                                       MessageBuilder* builder);
  };
} // namespace Roo::Server
