...
namespace Lisple
{
  namespace
  {
    ...
    bool option_bool(Value& options, const std::string& name, bool default_value)
    {
      ...
      {
        throw TypeError("lisple.io/list-directory! option :" + name +
    ...
    std::vector<std::string> option_filters(Value& options)
    {
      ...
      if (value->type == Value::Type::VECTOR)
      {
        ...
        for (const sptr_val& filter : value->elements())
        {
          ...
          {
            throw TypeError("lisple.io/list-directory! option :filter vector must contain "
                            "only strings, got: " +
                            filter->to_string());
          }
      ...
      throw TypeError(
        "lisple.io/list-directory! option :filter must be a string or vector, got: " +
        value->to_string());
    }
  ...
  /** ListDirectoryBangFunction - lisple.io/list-directory! */
  FUNC_IMPL(
  ...
  /** ExistsPFunction - lisple.io/exists? */
  ...
  /** DirectoryPFunction - lisple.io/directory? */
  ...
  /** StatBangFunction - lisple.io/stat! */
  ...
  /** AbsolutePathBangFunction - lisple.io/absolute-path! */
  ...
  /** CurrentDirectoryBangFunction - lisple.io/current-directory! */
  ...
  /** HomeDirectoryBangFunction - lisple.io/home-directory! */
