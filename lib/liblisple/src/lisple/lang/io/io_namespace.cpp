...
namespace Lisple
{
  namespace
  {
    Namespace make_io_namespace_named(const std::string& name)
    {
      ...
      return Namespace::make_lang(name, std::move(symbols));
    }
  } // namespace

  Namespace make_io_namespace() { return make_io_namespace_named("roo.io"); }

  Namespace make_lisple_io_namespace() { return make_io_namespace_named("lisple.io"); }
} // namespace Lisple
