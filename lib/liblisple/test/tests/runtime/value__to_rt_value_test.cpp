...
{
  Lisple::sptr_ast_node t = Lisple::AST::B_TRUE;
  Lisple::sptr_ast_node f = Lisple::AST::B_FALSE;
...
{
  Lisple::sptr_ast_node test_string = Lisple::AST::String::make("test-string");
...
{
  Lisple::sptr_ast_node_v ast_elements = {Lisple::AST::String::make("first"),
                                         Lisple::AST::String::make("second")};
  Lisple::sptr_ast_node ast_vector = Lisple::AST::Vector::make(std::move(ast_elements));
...
{
  Lisple::sptr_ast_node_v ast_elements = {Lisple::AST::Keyword::make("name"),
                                         Lisple::AST::String::make("Swedish Lion")};
  Lisple::sptr_ast_node ast_map = Lisple::AST::Map::make(std::move(ast_elements));
