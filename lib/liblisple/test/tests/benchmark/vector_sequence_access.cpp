...
namespace
{
  ...
  Lisple::sptr_val runtime_values()
  {
    Lisple::sptr_val_v values;
    values.reserve(NATIVE_VECTOR_SIZE);
    for (size_t i = 0; i < NATIVE_VECTOR_SIZE; i++)
    {
      values.push_back(Lisple::Value::number(static_cast<int>(i)));
    }

    return Lisple::Value::vector(std::move(values));
  }

  std::map<const std::string, Lisple::Namespace> native_sequence_namespaces()
  {
    Lisple::Namespace ns("bench.native-seq");
    ns.store("native-values", Lisple::NativeStdVectorAdapter<int>::make_ref(native_values()));
    ns.store("rt-values", runtime_values());
    ns.store("half-index", Lisple::Value::number(static_cast<int>(NATIVE_VECTOR_SIZE / 2)));
    ns.store("iterations", Lisple::Value::number(ACCESS_ITERATIONS));

    return {{"bench.native-seq", std::move(ns)}};
  }

  LispleTest::SnippetBenchmark vector_seq_benchmark(const std::string& case_name,
                                                    const std::string& input)
  {
    return LispleTest::SnippetBenchmark(
      case_name,
...
{
  auto bm = vector_seq_benchmark(
    "native_vector_nth_64k__100_iterations",
...
{
  auto bm = vector_seq_benchmark(
    "native_vector_head_64k__100_iterations",
...
{
  auto bm = vector_seq_benchmark(
    "native_vector_last_64k__100_iterations",
...
{
  auto bm = vector_seq_benchmark(
    "native_vector_take_1_64k__100_iterations",
...
{
  auto bm = vector_seq_benchmark(
    "native_vector_contains_first_64k__100_iterations",
...
{
  auto bm = vector_seq_benchmark(
    "native_vector_rand_nth_64k__100_iterations",
...
{
  auto bm = vector_seq_benchmark(
    "native_vector_tail_64k__100_iterations",
...
{
  auto bm = vector_seq_benchmark(
    "native_vector_partition_256_64k__100_iterations",
...
{
  auto bm = vector_seq_benchmark(
    "native_vector_concat_64k__100_iterations",
...
{
  auto bm = vector_seq_benchmark(
    "native_vector_contains_missing_64k__100_iterations",
...
{
  auto bm = vector_seq_benchmark(
    "rt_vector_nth_64k__100_iterations",
...
{
  auto bm = vector_seq_benchmark(
    "rt_vector_head_64k__100_iterations",
...
{
  auto bm = vector_seq_benchmark(
    "rt_vector_last_64k__100_iterations",
...
{
  auto bm = vector_seq_benchmark(
    "rt_vector_take_1_64k__100_iterations",
...
{
  auto bm = vector_seq_benchmark(
    "rt_vector_contains_first_64k__100_iterations",
...
{
  auto bm = vector_seq_benchmark(
    "rt_vector_rand_nth_64k__100_iterations",
...
{
  auto bm = vector_seq_benchmark(
    "rt_vector_tail_64k__100_iterations",
...
{
  auto bm = vector_seq_benchmark(
    "rt_vector_partition_256_64k__100_iterations",
...
{
  auto bm = vector_seq_benchmark(
    "rt_vector_concat_64k__100_iterations",
...
{
  auto bm = vector_seq_benchmark(
    "rt_vector_contains_missing_64k__100_iterations",
