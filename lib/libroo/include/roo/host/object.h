...
#ifndef ROO__HOST__OBJECT_H
#define ROO__HOST__OBJECT_H
...
#define NATIVE_ADAPTER_STATIC_FACTORY(AD_CLASS, H_CLASS)                \
  ...
  static Roo::sptr_val make_unique(Args&&... args)                 \
  {                                                                     \
   ...
   */                                                                   \
  static Roo::sptr_val claim(std::unique_ptr<H_CLASS>&& uptr)      \
  {                                                                     \
    return Roo::Value::native_object(                              \
   ...
   */                                                                   \
  template <typename... Args>                                           \
  static Roo::sptr_val make_shared(Args&&... args)                 \
  {                                                                     \
    return Roo::Value::native_object(                              \
   ...
   */                                                                   \
  template <typename... Args>                                           \
  static Roo::sptr_val wrap(const std::shared_ptr<H_CLASS>& sptr)  \
  {                                                                     \
    return Roo::Value::native_object(                              \
   ...
   */                                                                   \
  static Roo::sptr_val make_ref(const H_CLASS& ref)                \
  {                                                                     \
    return Roo::Value::native_object(                              \
...
#define NATIVE_ADAPTER_MAIN_DECL(AD_CLASS, H_CLASS)                     \
  class AD_CLASS : public Roo::NativeObject<H_CLASS>                 \
  {                                                                     \
  __NOBJ_TRAITS_DECL                                                    \
  public:                                                               \
   /*!                                                                  \
   ...
   static const Roo::NAccessorTable& static_accessor_table();        \
...
#define NATIVE_ADAPTER_GETTER_DECL(PROP_NAME)             \
  ...
  mutable Roo::NCacheSlot vcache_##PROP_NAME; \
  Roo::sptr_val get_##PROP_NAME() const;
...
#define NATIVE_ADAPTER_SETTER_DECL(PROP_NAME)                      \
  ...
  void set_##PROP_NAME(Roo::Context* ctx, Roo::sptr_val& value);
 ...
 * e.g. (Roo::NO_N_ACCESSORS) or ({entry, entry, ...}).
 */
#define __NOBJ_TRAITS_IMPL(AD_CLASS, HOBJ_T, ACCESSOR_MAP)                    \
  const Roo::NAccessorTable& AD_CLASS::static_accessor_table()              \
  {                                                                            \
    static const Roo::NAccessorTable t ACCESSOR_MAP;                        \
    return t;                                                                  \
  }                                                                            \
  const Roo::NativeObjectTraits* AD_CLASS::get_traits() const               \
  {                                                                            \
    static const Roo::NativeObjectTraits traits(HOBJ_T, static_accessor_table()); \
    return &traits;                                                            \
  }
...
#define __NOBJ_TRAITS_SUB_IMPL__ACCESSORS(AD_CLASS, AD_SUP_CLASS, HOBJ_T, ACCESSOR_MAP) \
  const Roo::NAccessorTable& AD_CLASS::static_accessor_table()              \
  {                                                                            \
    static const Roo::NAccessorTable t = Roo::merge_acc(                 \
      AD_SUP_CLASS::static_accessor_table(), Roo::NAccessorTable ACCESSOR_MAP); \
    return t;                                                                  \
  }                                                                            \
  const Roo::NativeObjectTraits* AD_CLASS::get_traits() const               \
  {                                                                            \
...
#define __NOBJ_P_GETTER(AD_CLASS, FN) [](const Roo::NativeObjectBase* adapter) { return dynamic_cast<const AD_CLASS*>(adapter)->FN(); }
#define __NOBJ_P_SETTER(AD_CLASS, FN) [](Roo::NativeObjectBase* adapter, Roo::Context* ctx, Roo::sptr_val& value) { dynamic_cast<AD_CLASS*>(adapter)->FN(ctx, value); }

#define __NOBJ_P_NO_GETTER Roo::n_no_getter
#define __NOBJ_P_NO_SETTER Roo::n_no_setter
...
#define __NOBJ_EXP_TAG_rw(AD, KEY, FIELD) \
  {KEY, Roo::NAccessors(__NOBJ_P_GETTER(AD, get_##FIELD), __NOBJ_P_SETTER(AD, set_##FIELD))}
#define __NOBJ_EXP_TAG_wo(AD, KEY, FIELD) \
  {KEY, Roo::NAccessors(__NOBJ_P_NO_GETTER, __NOBJ_P_SETTER(AD, set_##FIELD))}

/* 1-element spec: (field) - key inferred via stringification */
#define __NOBJ_EXP_1EL(AD, FIELD) \
  {#FIELD, Roo::NAccessors(__NOBJ_P_GETTER(AD, get_##FIELD), __NOBJ_P_NO_SETTER)}

/* 2-element spec: ("key", field) - explicit string key, getter only */
#define __NOBJ_EXP_2EL(AD, KEY, FIELD) \
  {KEY, Roo::NAccessors(__NOBJ_P_GETTER(AD, get_##FIELD), __NOBJ_P_NO_SETTER)}
...
#define NATIVE_ADAPTER_IMPL__NO_ACCESSORS(AD_CLASS, H_CLASS, HOBJ_T)         \
  __NOBJ_TRAITS_IMPL(AD_CLASS, HOBJ_T, (Roo::NO_N_ACCESSORS))             \
...
namespace Roo
{
  ...
  using n_acc_set_t = void (*)(NativeObjectBase*, Context*, Roo::sptr_val&);
   ...
   *
   * Stored as part of @see Roo::NativeObjectTraits, or one of its derived types.
   */
  class NAccessorTable
  {
   public:
