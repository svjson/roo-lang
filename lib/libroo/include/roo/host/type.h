#ifndef ROO__HOST__TYPE_H
#define ROO__HOST__TYPE_H
...
#define __HOST_TYPE(CONST, NAME, MAKE_FN) \
  inline const Roo::HostTypeRef CONST = Roo::HostTypeRef(NAME, MAKE_FN);

#define __HOST_TYPE__NO_MAKE_FN(CONST, NAME)                            \
  /*!                                                                   \
   * @brief Type definition for a Roo HostObject Adapter             \
   */                                                                   \
  inline const Roo::HostTypeRef CONST = Roo::HostTypeRef(NAME);
...
#define __HOST_SUB_TYPE(CONST, NAME, PARENT_TYPE, MAKE_FN)              \
  /*!                                                                   \
   * @brief Type definition for a Roo HostObject Adapter that is a   \
   * subtype of another Adapter, and with a registered make-function for\
   * automatic coercion.                                                \
   */                                                                   \
  inline const Roo::HostTypeRef CONST =                              \
    Roo::HostTypeRef(NAME, PARENT_TYPE, MAKE_FN);
...
#define __HOST_SUB_TYPE__NO_MAKE_FN(CONST, NAME, PARENT_TYPE)           \
   ...
   */                                                                   \
  inline const Roo::HostTypeRef CONST =                              \
    Roo::HostTypeRef(NAME, PARENT_TYPE);
...
namespace Roo
{
   ...
   * coercion from raw roo data structures to object instances.
   */
  class HostTypeRef : public TypeRef
  {
   ...
   public:
    ...
    /*!
     * @brief Attempts to coerce a Roo Runtime Value of a different type to this
