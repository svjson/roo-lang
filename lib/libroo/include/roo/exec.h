...
#define MULTI_SIG4(SIG1, SIG2, SIG3, SIG4) MULTI_SIG_PREAMBLE MULTI_SIG_PUSH(SIG1) MULTI_SIG_PUSH(SIG2) MULTI_SIG_PUSH(SIG3) MULTI_SIG_PUSH(SIG4) MULTI_SIG_TERMINATE
#define SELECT_MULTI_SIG(_1, _2, _3, _4, NAME, ...) NAME
#define EXPAND_MULTI_SIG(NAME, ...) NAME(__VA_ARGS__)
#define SIG(SINGLE_SIG_ARG) std::make_unique<Roo::sig> SINGLE_SIG_ARG
#define MULTI_SIG(...) EXPAND_MULTI_SIG(SELECT_MULTI_SIG(__VA_ARGS__, MULTI_SIG4, MULTI_SIG3, MULTI_SIG2, MULTI_SIG1), __VA_ARGS__)
