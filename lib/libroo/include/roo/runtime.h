...
namespace Roo
{
  ...
  class Runtime
  {
   ...
   public:
    ...
    Runtime(Runtime&&);
    /*!
     * @brief Creates a vanilla Roo runtime with only the language built-in
    ...
    /*!
     * @brief Creates a vanilla Roo runtime with independently configured
    ...
    /*!
     * @brief Creates a vanilla Roo runtime with no application file system
    ...
    /*!
     * @brief Creates a Roo runtime with a host-provided namespace in
    ...
    /*!
     * @brief Creates a Roo runtime with host-provided namespaces in
     * addition to the language built-in functions and no file system access.
     *
    ...
    /*!
     * @brief Creates a Roo runtime with a host-provided namespaces in
     * addition to the language built-in functions and file system access via
     * the provided FileSystem implementation.
     *
     * The provided namespaces will typically be the host application
    ...
    /*!
     * @brief Switch the namespace in which the roo engine currently operates.
     ...
     *
     * When enabled, invocation errors are annotated with Roo call context,
    ...
    sptr_val lookup(const std::string& identifier, const Roo::sptr_val& default_value);
