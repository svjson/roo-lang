...
namespace Roo
{
  ...
  bool Value::operator==(const Value& other) const
  {
    ...
    default:
      throw RooException("== not implemented for type: " + std::to_string((int)this->type));
    }
  }
  ...
  {
    return Roo::split_qualifiable(str());
  }
  ...
  sptr_val to_rt_value(const AST::ASTNode& obj)
  {
    ...
    case Form::SYMBOL:
      return Value::symbol(AST::Value<std::string>::value_of(obj));
    default:
      throw RooException("to_rt_value(AST::ASTNode&): Unsupported value type #" +
  ...
  sptr_val to_rt_value(std::shared_ptr<AST::ASTNode>& obj)
  {
    ...
    case Form::SYMBOL:
      return Value::symbol(AST::Value<std::string>::value_of(*obj));
    default:
      throw RooException("to_rt_value: Unsupported Value type(" +
  ...
  sptr_ast_node to_AST(Value& val)
  {
    ...
    case Value::Type::BOOL:
    {
      ...
      {
        return Roo::AST::Boolean::wrap(*bv);
      }
      else
      {
        throw RooException("Invalid Value(BOOL)");
      }
    }
    case Value::Type::CHAR:
    ...
    case Value::Type::KEYWORD:
    {
      ...
      {
        return Roo::AST::Keyword::make(*s);
      }
      else
      {
        throw RooException("Invalid Value(KEYWORD)");
      }
    }
    case Value::Type::LIST:
    {
      ...
      return Roo::AST::List::make(std::move(elements));
    }
    case Value::Type::MAP:
    {
      sptr_ast_node_v elements;
    ...
    case Value::Type::NUMBER:
    {
      if (const Value::Number* num = std::get_if<const Value::Number>(&val.value))
      {
        ...
        {
        case Value::NumberType::INT:
          return Roo::AST::Number::make(num->int_value);
        case Value::NumberType::LONG:
          return Roo::AST::Number::make(num->long_value);
        case Value::NumberType::FLOAT:
          return Roo::AST::Number::make(num->float_value);
        }
      }

      throw RooException("Invalid Value(NUMBER)");
    }
    case Value::Type::OBJECT:
      return std::get<sptr_ast_node>(val.value);
    case Value::Type::STRING:
      return Roo::AST::String::make(std::get<std::string>(val.value));
    case Value::Type::SYMBOL:
      return Roo::AST::Symbol::make(std::get<std::string>(val.value));
    case Value::Type::VECTOR:
    {
      sptr_ast_node_v elements;
      ...
      return Roo::AST::Vector::make(std::move(elements));
    }

    default:
      throw RooException("to_AST: Unsupported value type #" +
