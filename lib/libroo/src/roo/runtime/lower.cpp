...
namespace Roo
{
  ...
  std::unique_ptr<ExecNode> lower_expr(LowerContext& ctx, const sptr_ast_node& obj)
  {
    ...
    case Form::LIST:
    {
      ...
      {
        if (children.empty()) throw RooException("Cannot lower empty list");
    ...
    default:
      throw RooException("Lowering not implemented for form: " +
  ...
  std::unique_ptr<ExecNode> lower_literal(const sptr_ast_node& obj)
  {
    ...
    case Form::NUMBER:
    {
      ...
      {
      case Roo::AST::NumberType::INT:
        return std::make_unique<ExecNode>(
          obj,
          LiteralNode(Value::number(num_obj.int_value()), obj));
      case Roo::AST::NumberType::LONG:
        return std::make_unique<ExecNode>(
          obj,
    ...
    case Form::DISCARD:
      return std::make_unique<ExecNode>(Roo::Constant::NIL);
    default:
      throw RooException("Lowering not implemented for form: " + obj->to_string());
    }
  }
