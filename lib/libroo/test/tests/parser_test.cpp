...
TEST(Parser, parse_positive_int_numbers)
{
  ...
  // Then
  ASSERT_EQ(sexps.size(), 1);
  Roo::AST::Vector& vector = sexps.front()->as<Roo::AST::Vector>();
  ASSERT_EQ(vector.get_children().size(), 4);

  ASSERT_EQ(*vector.get_children().at(0), Roo::AST::Number(0));
  ASSERT_EQ(*vector.get_children().at(1), Roo::AST::Number(1));
  ASSERT_EQ(*vector.get_children().at(2), Roo::AST::Number(28));
  ASSERT_EQ(*vector.get_children().at(3), Roo::AST::Number(5945));
}
...
TEST(Parser, parse_negative_int_numbers)
{
  ...
  ASSERT_EQ(*vector.get_children().at(0), Roo::AST::Number(-1));
  ASSERT_EQ(*vector.get_children().at(1), Roo::AST::Number(-23));
  ASSERT_EQ(*vector.get_children().at(2), Roo::AST::Number(-853));
  ASSERT_EQ(*vector.get_children().at(3), Roo::AST::Number(-19345));
}
...
TEST(Parser, parse_positive_float_numbers)
{
  ...
  ASSERT_EQ(*vector.get_children().at(0), Roo::AST::Number(1.0f));
  ASSERT_EQ(*vector.get_children().at(1), Roo::AST::Number(45.0f));
  ASSERT_EQ(*vector.get_children().at(2), Roo::AST::Number(1.113f));
  ASSERT_EQ(*vector.get_children().at(3), Roo::AST::Number(1000.984f));
}
...
TEST(Parser, discard__list_form)
{
  ...
  // Then
  ASSERT_EQ(sexps.size(), 1);
  Roo::AST::Discard& discard = sexps.front()->as<Roo::AST::Discard>();
