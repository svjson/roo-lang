...
{
  RooTest::SnippetBenchmark bm("nested_for_100_x_100_x_100_map_construction",
                               R"(
...
{
  RooTest::SnippetBenchmark bm("nested_for_100_x_10000_x_10_map_construction",
                               R"(
    (let [height (range 0 100)
          width (range 0 10000)
          depth (range 0 10)]
...
{
  RooTest::SnippetBenchmark bm("nested_for_10_x_10_x_10_x_10_x_10_x_10_map_construction",
                               R"(
