...
using MergeFunction = RooTest::RuntimeTestFixture;
...
{
  // Given
  runtime.get_current_namespace().store("my-point",
                                        RooTest::Native::PointAdapter::make_unique(15, 30));
  ...
  EXPECT_EQ(retval->type, Roo::Value::Type::MAP);
}
