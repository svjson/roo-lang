...
using BitOperatorFunction = RooTest::RuntimeTestFixture;
...
{
  EXPECT_THROW(runtime.eval("(bit-and 1.5 1)"), Roo::TypeError);
  EXPECT_THROW(runtime.eval("(bit-or 1.5 1)"), Roo::TypeError);
  EXPECT_THROW(runtime.eval("(bit-xor 1.5 1)"), Roo::TypeError);
  EXPECT_THROW(runtime.eval("(bit-not 1.5)"), Roo::TypeError);
  EXPECT_THROW(runtime.eval("(<< 1.5 1)"), Roo::TypeError);
  EXPECT_THROW(runtime.eval("(>> 1.5 1)"), Roo::TypeError);
  EXPECT_THROW(runtime.eval("(<<< 1.5 1)"), Roo::TypeError);
  EXPECT_THROW(runtime.eval("(>>> 1.5 1)"), Roo::TypeError);
}
...
{
  EXPECT_THROW(runtime.eval("(<< 1 -1)"), Roo::RooException);
  EXPECT_THROW(runtime.eval("(>> 1 64)"), Roo::RooException);
  EXPECT_THROW(runtime.eval("(<<< 1 -1)"), Roo::RooException);
  EXPECT_THROW(runtime.eval("(>>> 1 64)"), Roo::RooException);
}
